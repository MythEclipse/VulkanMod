...
public abstract class Options {
        ...
        public static net.vulkanmod.config.gui.OptionBlock[] getVideoOpts() {
                ...
                net.vulkanmod.config.video.VideoModeSet videoModeSet = net.vulkanmod.config.video.VideoModeManager
                                .getFromVideoMode(videoMode);
                ...
                net.vulkanmod.config.option.CyclingOption<java.lang.Integer> RefreshRate = new net.vulkanmod.config.option.CyclingOption<>(
                                net.minecraft.network.chat.Component.translatable(
                                                "vulkanmod.options.refreshRate"),
                                (java.lang.Integer[]) refreshRates.toArray(new java.lang.Integer[0]),
                                value -> {
                                        net.vulkanmod.config.video.VideoModeManager.selectedVideoMode.refreshRate = ((Integer) value)
                                                        .intValue();
                                ...
                                () -> {
                                        return java.lang.Integer.valueOf(
                                                        net.vulkanmod.config.video.VideoModeManager.selectedVideoMode.refreshRate);
                                });
                RefreshRate.setTranslator(
                                refreshRate -> {
                                        return net.minecraft.network.chat.Component.nullToEmpty(
                                                        refreshRate.toString());
                                });
                net.vulkanmod.config.option.Option<net.vulkanmod.config.video.VideoModeSet> translator = new net.vulkanmod.config.option.CyclingOption<>(
                                net.minecraft.network.chat.Component.translatable(
                                                "options.fullscreen.resolution"),
                                net.vulkanmod.config.video.VideoModeManager.getVideoResolutions(),
                                value2 -> {
                                        net.vulkanmod.config.video.VideoModeManager.selectedVideoMode = value2
                                                        .getVideoMode(
                                                                        RefreshRate
                                                                                        .getNewValue());
                                        net.vulkanmod.config.video.VideoModeManager
                                ...
                                () -> {
                                        ...
                                        net.vulkanmod.config.video.VideoModeSet selectedVideoModeSet = net.vulkanmod.config.video.VideoModeManager
                ...
                translator.setOnChange(
                                () -> {
                                        net.vulkanmod.config.video.VideoModeSet newVideoMode = (net.vulkanmod.config.video.VideoModeSet) translator
                                                        .getNewValue();
                                        if (newVideoMode != null) {
                                                java.lang.Integer[] newRefreshRates = (java.lang.Integer[]) newVideoMode
                                                                .getRefreshRates()
                                                                ...
                                                                new net.vulkanmod.config.option.CyclingOption<>(
                                                                                ...
                                                                                () -> {
                                                                                        return java.util.Objects
                                                                                                        .requireNonNull(net.vulkanmod.config.video.WindowMode
                                                                                                                        .fromValue(
                                                                                                                                        config.windowMode));
                                                                                })
                                                                                .setTranslator(
                                                                                                value4 -> {
                                                                                                        return net.minecraft.network.chat.Component
                                                                                                                        .translatable(
                                                                                                                                        net.vulkanmod.config.video.WindowMode
                                                                                                                                                        .getComponentName(
                                                                                                                                                                        (net.vulkanmod.config.video.WindowMode) value4));
                                                                                                }),
                                                                new net.vulkanmod.config.option.RangeOption(
                                                                                ...
                                                                                value5 -> {
                                                                                        ...
                                                                                        if (value5.intValue() == 260) {
                                                                                                strValueOf = net.minecraft.network.chat.Component
                                                                                                                .translatable(
                                                                                                                                "options.framerateLimit.max")
                                                                                                                .getString();
                                                                                        } else {
                                                                                                strValueOf = java.lang.String
                                                                                                                .valueOf(value5);
                                                                                        }
                                                                                        return net.minecraft.network.chat.Component
                                                                                                        .nullToEmpty(
                                                                                ...
                                                                                value6 -> {
                                                                                        minecraftOptions.framerateLimit()
                                                                                                        .set(value6);
                                                                                        minecraft
                                                                                ...
                                                                                () -> {
                                                                                        return (java.lang.Integer) minecraftOptions
                                                                                                        .framerateLimit()
                                                                                                        .get();
                                                                                }),
                                                                new net.vulkanmod.config.option.SwitchOption(
                                                                                net.minecraft.network.chat.Component
                                                                                                .translatable("options.vsync"),
                                                                                value7 -> {
                                                                                        minecraftOptions.enableVsync()
                                                                                                        .set(value7);
                                                                                        window.updateVsync(value7
                                                                                                        .booleanValue());
                                                                                },
                                                                                () -> {
                                                                                        return (java.lang.Boolean) minecraftOptions
                                                                                                        .enableVsync()
                                                                                                        .get();
                                                                                }),
                                                                new net.vulkanmod.config.option.CyclingOption<>(
                                                                                ...
                                                                                value8 -> {
                                                                                        minecraftOptions
                                                                                                        .inactivityFpsLimit()
                                                                                                        .set(
                                                                                                                        (net.minecraft.client.InactivityFpsLimit) value8);
                                                                                },
                                                                                () -> {
                                                                                        return java.util.Objects
                                                                                                        .requireNonNull((net.minecraft.client.InactivityFpsLimit) minecraftOptions
                                                                                                                        .inactivityFpsLimit()
                                                                                                                        .get());
                                                                                })
                                                                                .setTranslator(
                                                                ...
                                                                new net.vulkanmod.config.option.RangeOption(
                                                                                net.minecraft.network.chat.Component
                                                                                                .translatable(
                                                                                                                "options.guiScale"),
                                                                                0,
                                                                                window.calculateScale(0, minecraft
                                                                                                .isEnforceUnicode()),
                                                                                1,
                                                                                value9 -> {
                                                                                        java.lang.String strValueOf;
                                                                ...
                                                                new net.vulkanmod.config.option.RangeOption(
                                                                                ...
                                                                                () -> {
                                                                                        return java.lang.Integer
                                                                                                        .valueOf(
                                                                                                                        (int) (((java.lang.Double) minecraftOptions
                                                                                                                                        .gamma()
                                                                                                                                        .get())
                                                                                                                                        .doubleValue()
                                                                                                                                        * 100.0d));
                                                                ...
                                                                new net.vulkanmod.config.option.CyclingOption<>(
                                                                                ...
                                                                                value14 -> {
                                                                                        minecraftOptions
                                                                                                        .attackIndicator()
                                                                                                        .set(
                                                                                                                        (net.minecraft.client.AttackIndicatorStatus) value14);
                                                                                },
                                                                                () -> {
                                                                                        return java.util.Objects
                                                                                                        .requireNonNull((net.minecraft.client.AttackIndicatorStatus) minecraftOptions
                                                                                                                        .attackIndicator()
                                                                                                                        .get());
                                                                                })
                                                                                .setTranslator(
        ...
        public static net.vulkanmod.config.gui.OptionBlock[] getGraphicsOpts() {
                net.vulkanmod.config.option.Option<?> translator = new net.vulkanmod.config.option.CyclingOption<>(
                                net.minecraft.network.chat.Component.translatable(
                                                "options.textureFiltering"),
                                net.minecraft.client.TextureFilteringMethod.values(),
                                value -> {
                                        net.minecraft.client.TextureFilteringMethod oldValue = (net.minecraft.client.TextureFilteringMethod) minecraftOptions
                                                        .textureFiltering().get();
                                        if ((oldValue == net.minecraft.client.TextureFilteringMethod.ANISOTROPIC
                                                        && value != net.minecraft.client.TextureFilteringMethod.ANISOTROPIC)
                                                        || (value == net.minecraft.client.TextureFilteringMethod.ANISOTROPIC
                                                                        && oldValue != net.minecraft.client.TextureFilteringMethod.ANISOTROPIC)) {
                                        ...
                                        minecraftOptions
                                                        .textureFiltering()
                                                        .set(
                                                                        (net.minecraft.client.TextureFilteringMethod) value);
                                },
                                () -> {
                                        return java.util.Objects.requireNonNull(
                                                        (net.minecraft.client.TextureFilteringMethod) minecraftOptions
                                                                        .textureFiltering().get());
                                })
                                .setTranslator(
                                                (v0) -> {
                ...
                net.vulkanmod.config.option.Option<java.lang.Integer> maxAnisotropyOption = new net.vulkanmod.config.option.RangeOption(
                                net.minecraft.network.chat.Component.translatable(
                                ...
                                1,
                                value2 -> {
                                        java.lang.Integer oldValue = (java.lang.Integer) minecraftOptions
                                                        .maxAnisotropyBit().get();
                                        if (minecraftOptions.textureFiltering()
                                                        .get() == net.minecraft.client.TextureFilteringMethod.ANISOTROPIC
                ...
                maxAnisotropyOption.setActivationFn(
                                () -> {
                                        return java.lang.Boolean.valueOf(
                                                        translator.getNewValue() == net.minecraft.client.TextureFilteringMethod.ANISOTROPIC);
                                });
                                ...
                                new net.vulkanmod.config.gui.OptionBlock(
                                                ...
                                                new net.vulkanmod.config.option.Option<?>[] {
                                                                new net.vulkanmod.config.option.RangeOption(
                                                                                ...
                                                                                1,
                                                                                value4 -> {
                                                                                        minecraftOptions.renderDistance()
                                                                                                        .set(value4);
                                                                                },
                                                                                () -> {
                                                                                        return (java.lang.Integer) minecraftOptions
                                                                ...
                                                                new net.vulkanmod.config.option.CyclingOption<>(
                                                                                ...
                                                                                value6 -> {
                                                                                        minecraftOptions
                                                                                                        ...
                                                                                                        .set(
                                                                                                                        (net.minecraft.client.PrioritizeChunkUpdates) value6);
                                                                                },
                                                                                () -> {
                                                                                        return java.util.Objects
                                                                                                        .requireNonNull((net.minecraft.client.PrioritizeChunkUpdates) minecraftOptions
                                                                                                                        .prioritizeChunkUpdates()
                                                                                                                        .get());
                                                                                })
                                                                                .setTranslator(
                                                                                                (v0) -> {
                                                                                                        return ((net.minecraft.client.PrioritizeChunkUpdates) v0)
                                                                                                                        .caption();
                                                                                                })
                                                }),
                                new net.vulkanmod.config.gui.OptionBlock(
                                                ...
                                                new net.vulkanmod.config.option.Option[] {
                                                                new net.vulkanmod.config.option.CyclingOption<>(
                                                                                ...
                                                                                value7 -> {
                                                                                        minecraftOptions
                                                                                                        .graphicsPreset()
                                                                                                        .set(
                                                                                                                        (net.minecraft.client.GraphicsPreset) value7);
                                                                                },
                                                                                () -> {
                                                                                        return (net.minecraft.client.GraphicsPreset) minecraftOptions
                                                                                                        .graphicsPreset()
                                                                                                        .get();
                                                                                })
                                                                                .setTranslator(
                                                                                                graphicsMode -> {
                                                                                                        return net.minecraft.network.chat.Component
                                                                                                                        .translatable(
                                                                                                                                        ((net.minecraft.client.GraphicsPreset) graphicsMode)
                                                                                                                                                        .getKey());
                                                                                                }),
                                                                translator,
                                                                maxAnisotropyOption,
                                                                new net.vulkanmod.config.option.CyclingOption<>(
                                                                                ...
                                                                                value8 -> {
                                                                                        minecraftOptions
                                                                                                        .particles()
                                                                                                        .set(
                                                                                                                        (net.minecraft.server.level.ParticleStatus) value8);
                                                                                },
                                                                                () -> {
                                                                                        return (net.minecraft.server.level.ParticleStatus) minecraftOptions
                                                                                                        .particles()
                                                                                                        .get();
                                                                                })
                                                                                .setTranslator(
                                                                ...
                                                                new net.vulkanmod.config.option.CyclingOption<>(
                                                                                ...
                                                                                () -> {
                                                                                        return java.util.Objects
                                                                                                        .requireNonNull((net.minecraft.client.CloudStatus) minecraftOptions
                                                                                                                        .cloudStatus()
                                                                                                                        .get());
                                                                                })
                                                                                .setTranslator(
                                                                ...
                                                                new net.vulkanmod.config.option.CyclingOption<>(
                                                                                ...
                                                                                value14 -> {
                                                                                        if (((Integer) value14)
                                                                                                        .intValue() > 0) {
                                                                                                minecraftOptions.ambientOcclusion()
                                                                                                                .set(true);
                                                                                        } else {
                                                                                                minecraftOptions.ambientOcclusion()
                                                                                                                .set(false);
                                                                                        }
                                                                                        config.ambientOcclusion = ((Integer) value14)
                                                                                                        .intValue();
                                ...
                                new net.vulkanmod.config.gui.OptionBlock(
                                                ...
                                                new net.vulkanmod.config.option.Option[] {
                                                                ...
                                                                new net.vulkanmod.config.option.RangeOption(
                                                                                ...
                                                                                1,
                                                                                value23 -> {
                                                                                        minecraftOptions.weatherRadius()
                                                                                                        .set(value23);
                                                                                },
                                                                                () -> {
                                                                                        return (java.lang.Integer) minecraftOptions
                                ...
                                new net.vulkanmod.config.gui.OptionBlock(
                                                ...
                                                new net.vulkanmod.config.option.Option[] {
                                                                new net.vulkanmod.config.option.CyclingOption<>(
                                                                                ...
                                                                                value -> {
                                                                                        config.advCulling = ((Integer) value)
                                                                                                        .intValue();
                                                                                },
                                                                                () -> {
                                                                                        return java.lang.Integer
                                                                                                        .valueOf(config.advCulling);
                                                                                })
                                                                                .setTranslator(
                                                                                                value2 -> {
                                                                                                        java.lang.String str;
                                                                                                        switch (((Integer) value2)
                                                                                                                        .intValue()) {
                                                                                                                case 1:
                                                                ...
                                                                new net.vulkanmod.config.option.SwitchOption(
                                                                                ...
                                                                                value3 -> {
                                                                                        config.entityCulling = value3
                                                                                                        .booleanValue();
                                                                                },
                                                                                () -> {
                                                                                        return java.lang.Boolean
                                                                                                        .valueOf(config.entityCulling);
                                                                                })
                                                                                .setTooltip(
                                                                                                net.minecraft.network.chat.Component
                                                                                                                .translatable(
                                                                ...
                                                                new net.vulkanmod.config.option.SwitchOption(
                                                                                ...
                                                                                value4 -> {
                                                                                        config.uniqueOpaqueLayer = value4
                                                                                                        .booleanValue();
                                                                ...
                                                                new net.vulkanmod.config.option.SwitchOption(
                                                                                ...
                                                                                value6 -> {
                                                                                        config.indirectDraw = value6
                                                                                                        .booleanValue();
                                                                                },
                                                                                () -> {
                                                                                        return java.lang.Boolean
                                                                                                        .valueOf(config.indirectDraw);
                                                                                })
                                                                                .setTooltip(
                                                                                                net.minecraft.network.chat.Component
                                                                                                                .translatable(
                                ...
                                new net.vulkanmod.config.gui.OptionBlock(
                                                ...
                                                new net.vulkanmod.config.option.Option<?>[] {
                                                                new net.vulkanmod.config.option.RangeOption(
                                                                                ...
                                                                                value -> {
                                                                                        config.builderThreads = value
                                                                                                        .intValue();
                                                                                        net.vulkanmod.render.chunk.WorldRenderer
                                                                                                        .getInstance()
                                                                                                        .getTaskDispatcher()
                                                                                                        .createThreads(value
                                                                                                                        .intValue());
                                                                ...
                                                                new net.vulkanmod.config.option.SwitchOption(
                                                                                ...
                                                                                value4 -> {
                                                                                        config.textureAnimations = value4
                                                                                                        .booleanValue();
                                                                                },
                                                                                () -> {
                                                                                        return java.lang.Boolean
                                                                                                        .valueOf(config.textureAnimations);
                                                                                })
                                                }),
                                new net.vulkanmod.config.gui.OptionBlock(
                                                "",
                                                new net.vulkanmod.config.option.Option[] {
                                                                new net.vulkanmod.config.option.CyclingOption<>(
                                                                                ...
                                                                                (java.lang.Integer[]) java.util.stream.IntStream
                                                                                                .range(
                                                                                                                -1,
                                                                                                                net.vulkanmod.vulkan.device.DeviceManager.suitableDevices
                                                                                                                                .size())
                                                                                                .boxed()
                                                                                                .toArray(
                                                                                                                x$0 -> {
                                                                                ...
                                                                                value5 -> {
                                                                                        config.device = ((Integer) value5)
                                                                                                        .intValue();
                                                                                },
                                                                                () -> {
                                                                                        return java.lang.Integer
                                                                                                        .valueOf(config.device);
                                                                                })
                                                                                .setTranslator(
                                                                                                value6 -> {
                                                                                                        java.lang.String str;
                                                                                                        if (((Integer) value6)
                                                                                                                ...
                                                                                                                str = net.vulkanmod.vulkan.device.DeviceManager.suitableDevices
                                                                                                                                .get(((Integer) value6)
                                                                                                                                                .intValue()).deviceName;
                                                                                                        }
                                                                                                        return net.minecraft.network.chat.Component
                                                                                                                                ...
                                                                                                                                "%s: %s"
                                                                                                                                                .formatted(
                                                                                                                                                                net.minecraft.network.chat.Component
                                                                                                                                                                                ...
                                                                                                                                                                                .getString(),
                                                                                                                                                                net.vulkanmod.vulkan.device.DeviceManager.device.deviceName)))
                                                })
                };
        }
}
