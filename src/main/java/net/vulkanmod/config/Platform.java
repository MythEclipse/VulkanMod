...
public abstract class Platform {
    ...
    // Actually detect the currently active Display Server (if both Wayland and X11 are present on
    // the system and/or GLFW is compiled to support both)
    ...
    private static int getSupportedPlat() {
        // Switch statement would be ideal, but couldn't find a good way of implementing it, so fell
        // back to basic if statements/branches
