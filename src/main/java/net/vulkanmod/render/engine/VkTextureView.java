...
public class VkTextureView extends com.mojang.blaze3d.textures.GpuTextureView {
    ...
    protected VkTextureView(net.vulkanmod.render.engine.VkGpuTexture gpuTexture, int baseMipLevel, int mipLevels) {
    ...
    public net.vulkanmod.render.engine.VkFbo getFbo(@org.jetbrains.annotations.Nullable com.mojang.blaze3d.textures.GpuTexture depthAttachment) {
        ...
        return (net.vulkanmod.render.engine.VkFbo) this.fboCache.computeIfAbsent(depthAttachmentId, j -> {
            return new net.vulkanmod.render.engine.VkFbo(this, (net.vulkanmod.render.engine.VkGpuTexture) depthAttachment);
        });
    }
    ...
    public void close() {
        ...
        it.unimi.dsi.fastutil.objects.ObjectIterator it = this.fboCache.values().iterator();
        while (it.hasNext()) {
    ...
    /* JADX INFO: renamed from: texture, reason: merged with bridge method [inline-methods] */
