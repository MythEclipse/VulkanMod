...
public class VkGpuDevice implements com.mojang.blaze3d.systems.GpuDevice {
    ...
    private final java.util.Map<
            ...
            pipelineCache = new java.util.IdentityHashMap();
    private final java.util.Map<
                    net.vulkanmod.render.engine.VkGpuDevice.ShaderCompilationKey,
                    com.mojang.blaze3d.opengl.GlShaderModule>
            shaderCache = new java.util.HashMap();
    private final java.util.Set<java.lang.String> enabledExtensions = new java.util.HashSet();
    private final java.util.Map<
                    net.vulkanmod.render.engine.VkGpuDevice.ShaderCompilationKey, java.lang.String>
            shaderSrcCache = new java.util.HashMap();
    private final int maxSupportedTextureSize =
            net.vulkanmod.vulkan.VRenderSystem.maxSupportedTextureSize();
    private final int uniformOffsetAlignment =
            (int)
                    net.vulkanmod.vulkan.device.DeviceManager.deviceProperties
                            .limits()
                            .minUniformBufferOffsetAlignment();
    private final net.vulkanmod.render.engine.VkCommandEncoder encoder =
            new net.vulkanmod.render.engine.VkCommandEncoder(this);
    ...
    public VkGpuDevice(
            ...
            boolean bl2) {
        this.debugLabels =
                net.vulkanmod.render.engine.VkDebugLabel.create(bl2, this.enabledExtensions);
    ...
    public com.mojang.blaze3d.textures.GpuTexture createTexture(
            @org.jetbrains.annotations.Nullable java.lang.String string,
            int usage,
            com.mojang.blaze3d.textures.TextureFormat textureFormat,
            int width,
            int height,
        ...
        net.vulkanmod.vulkan.texture.VulkanImage texture =
                net.vulkanmod.vulkan.texture.VulkanImage.builder(width, height)
                        .setName(string)
                        .setFormat(format)
        ...
        net.vulkanmod.render.engine.VkGpuTexture glTexture =
                new net.vulkanmod.render.engine.VkGpuTexture(
                        usage,
                        string,
                        textureFormat,
                        width,
    ...
    public net.vulkanmod.render.engine.VkGpuTexture gpuTextureFromVulkanImage(
        ...
        com.mojang.blaze3d.textures.TextureFormat textureFormat =
                net.vulkanmod.render.engine.VkGpuTexture.textureFormat(image.format);
    ...
    public com.mojang.blaze3d.textures.GpuTextureView createTextureView(
        ...
        if (startLevel >= 0 && startLevel + levels <= gpuTexture.getMipLevels()) {
            if (gpuTexture.getClass() != net.vulkanmod.render.engine.VkGpuTexture.class) {
                gpuTexture =
                        net.vulkanmod.render.engine.VkGpuTexture.fromGlTexture(
    ...
    public com.mojang.blaze3d.buffers.GpuBuffer createBuffer(
        ...
        net.vulkanmod.render.engine.VkGpuBuffer glBuffer =
                new net.vulkanmod.render.engine.VkGpuBuffer(
    ...
    private static int getMaxSupportedTextureSize() {
        ...
        while (true) {
            int j = iMax;
            if (j >= 1024) {
                com.mojang.blaze3d.opengl.GlStateManager._texImage2D(
                        32868, 0, 6408, j, j, 0, 6408, 5121, (java.nio.ByteBuffer) null);
                int k =
                        com.mojang.blaze3d.opengl.GlStateManager._getTexLevelParameter(
                                32868, 0, 4096);
                if (k == 0) {
                    iMax = j >> 1;
                } else {
                ...
                LOGGER.info(
                        "Failed to determine maximum texture size by probing, trying GL_MAX_TEXTURE_SIZE = {}",
                        java.lang.Integer.valueOf(jx));
                return jx;
            }
        }
    }
    ...
    public void clearPipelineCache() {
        for (com.mojang.blaze3d.opengl.GlRenderPipeline glRenderPipeline :
                this.pipelineCache.values()) {
    ...
    protected com.mojang.blaze3d.opengl.GlShaderModule getOrCompileShader(
        ...
        net.vulkanmod.render.engine.VkGpuDevice.ShaderCompilationKey shaderCompilationKey =
                new net.vulkanmod.render.engine.VkGpuDevice.ShaderCompilationKey(
    ...
    protected java.lang.String getCachedShaderSrc(
        ...
        return this.shaderSrcCache.computeIfAbsent(
                ...
                compilationKey -> {
                    ...
                    switch (net.vulkanmod.render.engine.VkGpuDevice.AnonymousClass1
                    ...
                    if (net.vulkanmod.render.shader.ShaderLoadUtil.REMAPPED_SHADERS.contains(
                        ...
                        java.lang.String src =
                                net.vulkanmod.render.shader.ShaderLoadUtil.getShaderSource(
    ...
    private com.mojang.blaze3d.opengl.GlShaderModule compileShader(
        ...
        java.lang.String string =
                biFunction.apply(shaderCompilationKey.id, shaderCompilationKey.type);
        if (string == null) {
            LOGGER.error(
        ...
        int i =
                com.mojang.blaze3d.opengl.GlStateManager.glCreateShader(
        ...
        com.mojang.blaze3d.opengl.GlShaderModule glShaderModule =
                new com.mojang.blaze3d.opengl.GlShaderModule(
    ...
    private void compilePipeline(
        ...
        net.vulkanmod.vulkan.shader.Pipeline.Builder builder =
                new net.vulkanmod.vulkan.shader.Pipeline.Builder(
                        renderPipeline.getVertexFormat(), configName);
        net.vulkanmod.interfaces.shader.ExtendedRenderPipeline extPipeline =
        ...
        net.minecraft.resources.Identifier fragmentShaderLocation =
                renderPipeline.getFragmentShader();
        net.minecraft.client.renderer.ShaderDefines shaderDefines =
                renderPipeline.getShaderDefines();
        java.lang.String vshSrc =
                getCachedShaderSrc(
                        vertexShaderLocation,
                        com.mojang.blaze3d.shaders.ShaderType.VERTEX,
                        shaderDefines,
                        shaderSrcGetter);
        java.lang.String fshSrc =
                getCachedShaderSrc(
                        fragmentShaderLocation,
                        com.mojang.blaze3d.shaders.ShaderType.FRAGMENT,
                        shaderDefines,
                        shaderSrcGetter);
        java.lang.String vshSrc2 =
                com.mojang.blaze3d.preprocessor.GlslPreprocessor.injectDefines(
                        vshSrc, shaderDefines);
        java.lang.String fshSrc2 =
                com.mojang.blaze3d.preprocessor.GlslPreprocessor.injectDefines(
                        fshSrc, shaderDefines);
        net.vulkanmod.vulkan.shader.converter.Lexer lexer =
                new net.vulkanmod.vulkan.shader.converter.Lexer(vshSrc2);
        net.vulkanmod.vulkan.shader.converter.GLSLParser parser =
                new net.vulkanmod.vulkan.shader.converter.GLSLParser();
        ...
        try {
            ...
            net.vulkanmod.vulkan.shader.converter.Lexer lexer2 =
                    new net.vulkanmod.vulkan.shader.converter.Lexer(fshSrc2);
            ...
            java.lang.String vshProcessed =
                    parser.getOutput(net.vulkanmod.vulkan.shader.converter.GLSLParser.Stage.VERTEX);
            java.lang.String fshProcessed =
                    parser.getOutput(
            ...
            try {
                ...
                net.vulkanmod.render.engine.EGlProgram eGlProgram =
                        new net.vulkanmod.render.engine.EGlProgram(1, configName);
