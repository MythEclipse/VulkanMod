...
public class VkGpuDevice implements com.mojang.blaze3d.systems.GpuDevice {
        ...
        // net.vulkanmod.vulkan.VRenderSystem.maxSupportedTextureSize();
        private final int uniformOffsetAlignment = (int) net.vulkanmod.vulkan.device.DeviceManager.deviceProperties
                        .limits()
                        .minUniformBufferOffsetAlignment();
        private final net.vulkanmod.render.engine.VkCommandEncoder encoder = new net.vulkanmod.render.engine.VkCommandEncoder(
                        this);
        ...
        public com.mojang.blaze3d.textures.GpuSampler createSampler(
                        com.mojang.blaze3d.textures.AddressMode addressMode,
                        com.mojang.blaze3d.textures.AddressMode addressMode2,
                        com.mojang.blaze3d.textures.FilterMode filterMode,
                        com.mojang.blaze3d.textures.FilterMode filterMode2,
                        int maxAnisotropy,
                        java.util.OptionalDouble maxLod) {
                return new net.vulkanmod.render.engine.VkSampler(
                                addressMode, addressMode2, filterMode, filterMode2, maxAnisotropy, maxLod);
        }
        ...
        public com.mojang.blaze3d.textures.GpuTexture createTexture(
                ...
                return createTexture(
                                (!this.debugLabels.exists() || supplier == null) ? null : supplier.get(),
                                usage,
                                textureFormat,
                                width,
                                height,
        ...
        public com.mojang.blaze3d.textures.GpuTexture createTexture(
                ...
                net.vulkanmod.vulkan.texture.VulkanImage texture = net.vulkanmod.vulkan.texture.VulkanImage
                ...
                net.vulkanmod.render.engine.VkGpuTexture glTexture = new net.vulkanmod.render.engine.VkGpuTexture(
                                usage,
                                string,
                                textureFormat,
                                width,
        ...
        public net.vulkanmod.render.engine.VkGpuTexture gpuTextureFromVulkanImage(
                        net.vulkanmod.vulkan.texture.VulkanImage image) {
                int id = net.vulkanmod.gl.VkGlTexture.genTextureId();
                net.vulkanmod.gl.VkGlTexture glTexture = net.vulkanmod.gl.VkGlTexture.getTexture(id);
                glTexture.setVulkanImage(image);
                com.mojang.blaze3d.textures.TextureFormat textureFormat = net.vulkanmod.render.engine.VkGpuTexture
                                .textureFormat(image.format);
                net.vulkanmod.render.engine.VkGpuTexture gpuTexture = new net.vulkanmod.render.engine.VkGpuTexture(
                                0,
                                image.name,
                                textureFormat,
                                image.width,
        ...
        @Override
        public com.mojang.blaze3d.textures.GpuTextureView createTextureView(
                        com.mojang.blaze3d.textures.GpuTexture gpuTexture, int startLevel, int levels) {
                if (gpuTexture.isClosed()) {
                        throw new java.lang.IllegalArgumentException(
                                        "Can't create texture view with closed texture");
                }
                if (startLevel >= 0 && startLevel + levels <= gpuTexture.getMipLevels()) {
                        if (gpuTexture.getClass() != net.vulkanmod.render.engine.VkGpuTexture.class) {
                                gpuTexture = net.vulkanmod.render.engine.VkGpuTexture.fromGlTexture(
                                                (com.mojang.blaze3d.opengl.GlTexture) gpuTexture);
                        }
                        return new net.vulkanmod.render.engine.VkTextureView(
                                        (net.vulkanmod.render.engine.VkGpuTexture) gpuTexture, startLevel, levels);
                }
                throw new java.lang.IllegalArgumentException(
                                levels
        ...
        public com.mojang.blaze3d.buffers.GpuBuffer createBuffer(
                ...
                net.vulkanmod.render.engine.VkGpuBuffer glBuffer = new net.vulkanmod.render.engine.VkGpuBuffer(
                                this.debugLabels, supplier, usage, byteBuffer.remaining());
        ...
        public java.lang.String getImplementationInformation() {
                return "Vulkan "
                                + net.vulkanmod.vulkan.Vulkan.getDevice().vkVersion
                                + ", "
                                + net.vulkanmod.vulkan.Vulkan.getDevice().vendorIdString;
        }
        ...
        public int getMaxTextureSize() {
                return net.vulkanmod.vulkan.VRenderSystem.maxSupportedTextureSize();
        }
        ...
        protected com.mojang.blaze3d.opengl.GlShaderModule getOrCompileShader(
                        net.minecraft.resources.Identifier resourceLocation,
                        com.mojang.blaze3d.shaders.ShaderType shaderType,
                        net.minecraft.client.renderer.ShaderDefines shaderDefines,
                        java.util.function.BiFunction<net.minecraft.resources.Identifier, com.mojang.blaze3d.shaders.ShaderType, java.lang.String> biFunction) {
                net.vulkanmod.render.engine.VkGpuDevice.ShaderCompilationKey shaderCompilationKey = new net.vulkanmod.render.engine.VkGpuDevice.ShaderCompilationKey(
                                resourceLocation, shaderType, shaderDefines);
                return this.shaderCache.computeIfAbsent(
                                shaderCompilationKey,
                                shaderCompilationKey2 -> {
                                        return compileShader(shaderCompilationKey, biFunction);
                                });
        }

        protected java.lang.String getCachedShaderSrc(
                        net.minecraft.resources.Identifier resourceLocation,
                        com.mojang.blaze3d.shaders.ShaderType shaderType,
                        net.minecraft.client.renderer.ShaderDefines shaderDefines,
                        com.mojang.blaze3d.shaders.ShaderSource shaderSourceGetter) {
                net.vulkanmod.render.engine.VkGpuDevice.ShaderCompilationKey shaderCompilationKey = new net.vulkanmod.render.engine.VkGpuDevice.ShaderCompilationKey(
                                resourceLocation, shaderType, shaderDefines);
                return this.shaderSrcCache.computeIfAbsent(
                                shaderCompilationKey,
                                compilationKey -> {
                                        java.lang.String str;
                                        switch (net.vulkanmod.render.engine.VkGpuDevice.AnonymousClass1.$SwitchMap$com$mojang$blaze3d$shaders$ShaderType[shaderType
                                                        .ordinal()]) {
                                                case 1:
                                                        str = ".vsh";
                                                        break;
                                        ...
                                        if (net.vulkanmod.render.shader.ShaderLoadUtil.REMAPPED_SHADERS.contains(
                                                        shaderName)) {
                                                java.lang.String src = net.vulkanmod.render.shader.ShaderLoadUtil
                                                                .getShaderSource(
                                                                                resourceLocation, shaderType);
                                                if (src == null) {
                                                        throw new java.lang.RuntimeException(
                                                                        "shader: (%s) not found.".formatted(src));
                                                }
                                                return src;
                                        }
        ...
        /*
         * JADX INFO: renamed from: net.vulkanmod.render.engine.VkGpuDevice$1, reason:
         * invalid class name
         */
        /*
         * JADX INFO: loaded from:
         * VulkanMod_1.21.11-0.6.0.jar:net/vulkanmod/render/engine/VkGpuDevice$1.class
         */
        ...
        public com.mojang.blaze3d.pipeline.CompiledRenderPipeline precompilePipeline(
                ...
                try {
                        ...
                        throw new java.lang.RuntimeException(
                                        "Caught exception compiling pipeline: %s".formatted(renderPipeline.toString()),
                                        e);
                }
        }
        ...
        private com.mojang.blaze3d.opengl.GlShaderModule compileShader(
                        net.vulkanmod.render.engine.VkGpuDevice.ShaderCompilationKey shaderCompilationKey,
                        java.util.function.BiFunction<net.minecraft.resources.Identifier, com.mojang.blaze3d.shaders.ShaderType, java.lang.String> biFunction) {
                java.lang.String string = biFunction.apply(shaderCompilationKey.id, shaderCompilationKey.type);
                if (string == null) {
                        LOGGER.error(
                                        "Couldn't find source for {} shader ({})",
                                        shaderCompilationKey.type,
                                        shaderCompilationKey.id);
                        return com.mojang.blaze3d.opengl.GlShaderModule.INVALID_SHADER;
                }
                java.lang.String string2 = com.mojang.blaze3d.preprocessor.GlslPreprocessor.injectDefines(
                                string, shaderCompilationKey.defines);
                int i = com.mojang.blaze3d.opengl.GlStateManager.glCreateShader(
                                com.mojang.blaze3d.opengl.GlConst.toGl(shaderCompilationKey.type));
                ...
                if (com.mojang.blaze3d.opengl.GlStateManager.glGetShaderi(i, 35713) == 0) {
                        java.lang.String string3 = org.apache.commons.lang3.StringUtils.trim(
                                        com.mojang.blaze3d.opengl.GlStateManager.glGetShaderInfoLog(i, 32768));
                        LOGGER.error(
                                        "Couldn't compile {} shader ({}): {}",
                                        new java.lang.Object[] {
                                                        shaderCompilationKey.type.getName(), shaderCompilationKey.id,
                                                        string3
                                        });
                        return com.mojang.blaze3d.opengl.GlShaderModule.INVALID_SHADER;
                }
                com.mojang.blaze3d.opengl.GlShaderModule glShaderModule = new com.mojang.blaze3d.opengl.GlShaderModule(
                                i, shaderCompilationKey.id, shaderCompilationKey.type);
        ...
        private void compilePipeline(
                        com.mojang.blaze3d.pipeline.RenderPipeline renderPipeline,
                        com.mojang.blaze3d.shaders.ShaderSource shaderSrcGetter) {
                ...
                net.vulkanmod.vulkan.shader.Pipeline.Builder builder = new net.vulkanmod.vulkan.shader.Pipeline.Builder(
                                renderPipeline.getVertexFormat(), configName);
                net.vulkanmod.interfaces.shader.ExtendedRenderPipeline extPipeline = net.vulkanmod.interfaces.shader.ExtendedRenderPipeline
                                .of(renderPipeline);
                ...
                java.lang.String vshSrc = getCachedShaderSrc(
                                vertexShaderLocation,
                                com.mojang.blaze3d.shaders.ShaderType.VERTEX,
                                shaderDefines,
                                shaderSrcGetter);
                java.lang.String fshSrc = getCachedShaderSrc(
                                fragmentShaderLocation,
                                com.mojang.blaze3d.shaders.ShaderType.FRAGMENT,
                                shaderDefines,
                                shaderSrcGetter);
                java.lang.String vshSrc2 = com.mojang.blaze3d.preprocessor.GlslPreprocessor.injectDefines(
                                vshSrc, shaderDefines);
                java.lang.String fshSrc2 = com.mojang.blaze3d.preprocessor.GlslPreprocessor.injectDefines(
                                fshSrc, shaderDefines);
                net.vulkanmod.vulkan.shader.converter.Lexer lexer = new net.vulkanmod.vulkan.shader.converter.Lexer(
                                vshSrc2);
                ...
                try {
                        ...
                        net.vulkanmod.vulkan.shader.converter.Lexer lexer2 = new net.vulkanmod.vulkan.shader.converter.Lexer(
                                        fshSrc2);
                        ...
                        java.lang.String vshProcessed = parser
                                        .getOutput(net.vulkanmod.vulkan.shader.converter.GLSLParser.Stage.VERTEX);
                        java.lang.String fshProcessed = parser.getOutput(
                                        net.vulkanmod.vulkan.shader.converter.GLSLParser.Stage.FRAGMENT);
                        ...
                        try {
                                net.vulkanmod.vulkan.shader.GraphicsPipeline pipeline = builder
                                                .createGraphicsPipeline();
                                net.vulkanmod.render.engine.EGlProgram eGlProgram = new net.vulkanmod.render.engine.EGlProgram(
                                                1, configName);
                                eGlProgram.setupUniforms(
                                                pipeline, renderPipeline.getUniforms(), renderPipeline.getSamplers());
                                extPipeline.setProgram(eGlProgram);
                                extPipeline.setPipeline(pipeline);
                        } catch (java.lang.Exception e) {
                                e.printStackTrace();
                                throw new java.lang.RuntimeException(
                                                "Exception while compiling pipeline %s".formatted(renderPipeline));
                        }
                } catch (java.lang.Exception e2) {
                        throw new java.lang.RuntimeException(
                                        "Caught exception while parsing: %s".formatted(renderPipeline.toString()), e2);
                }
        }
        ...
        record ShaderCompilationKey(
                ...
                public String toString() {
                        ...
                        return !this.defines.isEmpty()
                                        ? string + " with " + String.valueOf(this.defines)
                                        : string;
                }
        }
        ...
        /*
         * JADX INFO: loaded from:
         * VulkanMod_1.21.11-0.6.0.jar:net/vulkanmod/render/engine/
         * VkGpuDevice$VkRenderPipeline.class
         */
        private static class VkRenderPipeline
                        implements com.mojang.blaze3d.pipeline.CompiledRenderPipeline {
