...
public class DrawBuffers {
    ...
    public static final int VERTEX_SIZE =
            net.vulkanmod.render.PipelineManager.terrainVertexFormat.getVertexSize();
    ...
    public static final float POS_OFFSET =
            net.vulkanmod.render.vertex.CustomVertexFormat.getPositionOffset();
    private static final long cmdBufferPtr =
            org.lwjgl.system.MemoryUtil.nmemAlignedAlloc(
    ...
    private final java.util.EnumMap<
                    ...
                    net.vulkanmod.render.chunk.buffer.AreaBuffer>
            vertexBuffers =
                    new java.util.EnumMap<>(net.vulkanmod.render.vertex.TerrainRenderType.class);
    private final net.vulkanmod.vulkan.memory.buffer.UniformBuffer sectionDataBuffer =
            new net.vulkanmod.vulkan.memory.buffer.UniformBuffer(
    ...
    final long drawParamsPtr =
            net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.allocateBuffer();
    ...
    public void upload(
        ...
        if (buffer.indexOnly) {
            long paramsPtr =
                    net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.getParamsPtr(
                            ...
                            net.vulkanmod.render.chunk.cull.QuadFacing.UNDEFINED.ordinal());
            int firstIndex =
                    net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.getFirstIndex(paramsPtr);
            int indexCount =
                    net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.getIndexCount(paramsPtr);
            int oldOffset = indexCount > 0 ? firstIndex : -1;
            int firstIndex2 =
                    this.indexBuffer.upload(buffer.getIndexBuffer(), oldOffset, paramsPtr).offset
                            / 2;
        ...
        for (int i = 0; i < net.vulkanmod.render.chunk.cull.QuadFacing.COUNT; i++) {
            int vertexOffset =
                    net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.getVertexOffset(
                            net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.getParamsPtr(
                                    this.drawParamsPtr,
                                    section.inAreaIndex,
                                    renderType.ordinal(),
        ...
        net.vulkanmod.render.chunk.buffer.AreaBuffer.Segment segment =
                areaBuffer.allocateSegment(size);
        ...
        for (int i2 = 0; i2 < net.vulkanmod.render.chunk.cull.QuadFacing.COUNT; i2++) {
            ...
            if (i2 == net.vulkanmod.render.chunk.cull.QuadFacing.UNDEFINED.ordinal()
                ...
                if (this.indexBuffer == null) {
                    this.indexBuffer =
                            new net.vulkanmod.render.chunk.buffer.AreaBuffer(
                                    net.vulkanmod.render.chunk.buffer.AreaBuffer.Usage.INDEX,
                                    60000,
                                    2);
                }
                int oldOffset3 =
                        net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.getIndexCount(
                                                paramPtr)
                                        > 0
                                ? net.vulkanmod.render.chunk.buffer.DrawParametersBuffer
                                        .getFirstIndex(paramPtr)
                                : -1;
                net.vulkanmod.render.chunk.buffer.AreaBuffer.Segment ibSegment =
                        this.indexBuffer.upload(buffer.getIndexBuffer(), oldOffset3, paramPtr);
    ...
    private void updateUniformData(net.vulkanmod.render.chunk.RenderSection section) {
        int encodedOffset =
                encodeSectionOffset(section.xOffset(), section.yOffset(), section.zOffset());
        ...
        if (section.getCompiledSection()
                == net.vulkanmod.render.chunk.build.task.CompiledSection.UNCOMPILED) {
    ...
    private net.vulkanmod.render.chunk.buffer.AreaBuffer getAreaBufferOrAlloc(
        ...
        int initialSize = i;
        return (net.vulkanmod.render.chunk.buffer.AreaBuffer)
                this.vertexBuffers.computeIfAbsent(
                        renderType,
                        renderType1 -> {
    ...
    public void buildDrawBatchesIndirect(
            ...
            net.vulkanmod.render.chunk.util.StaticQueue<net.vulkanmod.render.chunk.RenderSection>
                    queue,
        ...
        boolean backFaceCulling =
                net.vulkanmod.Initializer.CONFIG.backFaceCulling && !isTranslucent;
        int drawCount = 0;
        long drawParamsBasePtr =
                this.drawParamsPtr + (((long) (terrainRenderType.ordinal() * 512 * 7)) * 16);
        int count = 0;
        if (backFaceCulling) {
            java.util.Iterator<net.vulkanmod.render.chunk.RenderSection> iterator =
                    queue.iterator(isTranslucent);
            ...
            java.util.Iterator<net.vulkanmod.render.chunk.RenderSection> iterator2 =
                    queue.iterator(isTranslucent);
            ...
            for (int i2 = 0; i2 < count; i2++) {
                ...
                int indexCount2 =
                        net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.getIndexCount(
                                drawParamsPtr2);
                int firstIndex2 =
                        net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.getFirstIndex(
                                drawParamsPtr2);
                int vertexOffset2 =
                        net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.getVertexOffset(
                                drawParamsPtr2);
                int baseInstance2 =
                        net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.getBaseInstance(
                                drawParamsPtr2);
                if (indexCount2 > 0) {
    ...
    public void buildDrawBatchesDirect(
        ...
        if (backFaceCulling) {
            ...
            for (int j = 0; j < count; j++) {
                ...
                if (indexCount > 0) {
                    org.lwjgl.vulkan.VK10.vkCmdDrawIndexed(
                            commandBuffer, indexCount, 1, firstIndex, vertexOffset, baseInstance);
                }
            }
            return;
        }
        ...
        for (int i2 = 0; i2 < count; i2++) {
            ...
            if (indexCount2 > 0) {
                org.lwjgl.vulkan.VK10.vkCmdDrawIndexed(
                        commandBuffer, indexCount2, 1, firstIndex2, vertexOffset2, baseInstance2);
            }
        }
    }
    ...
    public void bindBuffers(
        ...
        try {
            net.vulkanmod.render.chunk.buffer.AreaBuffer vertexBuffer =
                    getAreaBuffer(terrainRenderType);
