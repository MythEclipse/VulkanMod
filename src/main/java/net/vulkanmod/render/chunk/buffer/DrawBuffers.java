...
public class DrawBuffers {
        ...
        private static final long cmdBufferPtr = org.lwjgl.system.MemoryUtil.nmemAlignedAlloc(
                        32, (512 * ((long) net.vulkanmod.render.chunk.cull.QuadFacing.COUNT)) * 32);
        private boolean allocated = false;
        private final java.util.EnumMap<net.vulkanmod.render.vertex.TerrainRenderType, net.vulkanmod.render.chunk.buffer.AreaBuffer> vertexBuffers = new java.util.EnumMap<>(
                        net.vulkanmod.render.vertex.TerrainRenderType.class);
        private final net.vulkanmod.vulkan.memory.buffer.UniformBuffer sectionDataBuffer = new net.vulkanmod.vulkan.memory.buffer.UniformBuffer(
                        4096, net.vulkanmod.vulkan.memory.MemoryTypes.HOST_MEM);
        ...
        public DrawBuffers(org.joml.Vector3i origin, int minHeight) {
                this.origin = origin;
         ...
         */
        public void upload(
                        net.vulkanmod.render.chunk.RenderSection section,
                        net.vulkanmod.render.chunk.build.UploadBuffer buffer,
                ...
                if (buffer.indexOnly) {
                        long paramsPtr = net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.getParamsPtr(
                                        this.drawParamsPtr,
                                        section.inAreaIndex,
                                        renderType.ordinal(),
                                        net.vulkanmod.render.chunk.cull.QuadFacing.UNDEFINED.ordinal());
                        int firstIndex = net.vulkanmod.render.chunk.buffer.DrawParametersBuffer
                                        .getFirstIndex(paramsPtr);
                        int indexCount = net.vulkanmod.render.chunk.buffer.DrawParametersBuffer
                                        .getIndexCount(paramsPtr);
                        int oldOffset = indexCount > 0 ? firstIndex : -1;
                        int firstIndex2 = this.indexBuffer.upload(buffer.getIndexBuffer(), oldOffset, paramsPtr).offset
                                        / 2;
                        net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.setFirstIndex(
                                        paramsPtr, firstIndex2);
                        buffer.release();
                        return;
                }
                int oldOffset2 = -1;
                ...
                for (int i = 0; i < net.vulkanmod.render.chunk.cull.QuadFacing.COUNT; i++) {
                        int vertexOffset = net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.getVertexOffset(
                                        net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.getParamsPtr(
                                                        this.drawParamsPtr,
                                                        section.inAreaIndex,
                                                        renderType.ordinal(),
                                                        i));
                ...
                for (int i2 = 0; i2 < net.vulkanmod.render.chunk.cull.QuadFacing.COUNT; i2++) {
                        long paramPtr = net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.getParamsPtr(
                                        this.drawParamsPtr, section.inAreaIndex, renderType.ordinal(), i2);
                        int vertexOffset2 = -1;
                        int firstIndex3 = 0;
                        int indexCount2 = 0;
                        ...
                        if (i2 == net.vulkanmod.render.chunk.cull.QuadFacing.UNDEFINED.ordinal()
                                        && !buffer.autoIndices) {
                                if (this.indexBuffer == null) {
                                        this.indexBuffer = new net.vulkanmod.render.chunk.buffer.AreaBuffer(
                                                        net.vulkanmod.render.chunk.buffer.AreaBuffer.Usage.INDEX,
                                                        60000,
                                                        2);
                                }
                                int oldOffset3 = net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.getIndexCount(
                                                paramPtr) > 0
                                                                ? net.vulkanmod.render.chunk.buffer.DrawParametersBuffer
                                                                                .getFirstIndex(paramPtr)
                                                                : -1;
                                net.vulkanmod.render.chunk.buffer.AreaBuffer.Segment ibSegment = this.indexBuffer
                                                .upload(buffer.getIndexBuffer(), oldOffset3, paramPtr);
                                firstIndex3 = ibSegment.offset / 2;
                        } else {
                                net.vulkanmod.vulkan.Renderer.getDrawer()
                                                .getQuadsIndexBuffer()
                                                .checkCapacity(vertexCount);
                        }
                        net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.setIndexCount(
                                        paramPtr, indexCount2);
                        net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.setFirstIndex(
                                        paramPtr, firstIndex3);
                        net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.setVertexOffset(
                                        paramPtr, vertexOffset2);
                        net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.setBaseInstance(
                                        paramPtr, baseInstance);
                }
        ...
        private void updateUniformData(net.vulkanmod.render.chunk.RenderSection section) {
                ...
                org.lwjgl.system.MemoryUtil.memPutInt(
                                this.sectionDataBuffer.getPointer() + ((long) ptrOffset), encodedOffset);
        ...
        private void updateFadeUniform(long currentTime, int fadeTimeMs, float fadeTimeInv) {
                if (this.lastFadeUpdate < this.latestBuildTime + ((long) fadeTimeMs)) {
                        ...
                        for (int i = 0; i < 512; i++) {
                                ...
                                float fade = fadeTimeMs > 0
                                                ? net.minecraft.util.Mth.clamp(delta * fadeTimeInv, 0.0f, 1.0f)
                                                : 1.0f;
                                org.lwjgl.system.MemoryUtil.memPutFloat(
                                                this.sectionDataBuffer.getPointer() + ((long) ptrOffset), fade);
                                ptrOffset += 4;
                        }
         ...
         * java.lang.MatchException
         */
        private net.vulkanmod.render.chunk.buffer.AreaBuffer getAreaBufferOrAlloc(
                        net.vulkanmod.render.vertex.TerrainRenderType renderType)
                        throws java.lang.MatchException {
                int i;
                this.allocated = true;
                switch (renderType) {
                        ...
                        default:
                                throw new java.lang.MatchException(
                                                "Unknown renderType", (java.lang.Throwable) null);
                }
                int initialSize = i;
                return (net.vulkanmod.render.chunk.buffer.AreaBuffer) this.vertexBuffers.computeIfAbsent(
                                renderType,
                                renderType1 -> {
                                        return new net.vulkanmod.render.chunk.buffer.AreaBuffer(
                                                        net.vulkanmod.render.chunk.buffer.AreaBuffer.Usage.VERTEX,
                                                        initialSize,
                                                        VERTEX_SIZE);
                                });
        }

        public net.vulkanmod.render.chunk.buffer.AreaBuffer getAreaBuffer(
                        net.vulkanmod.render.vertex.TerrainRenderType r) {
        ...
        private void updateChunkAreaOrigin(
                ...
                org.lwjgl.vulkan.VK10.vkCmdPushConstants(
                                commandBuffer, pipeline.getLayout(), 1, 0, byteBuffer);
        }

        public void buildDrawBatchesIndirect(
                        net.minecraft.world.phys.Vec3 cameraPos,
                        net.vulkanmod.vulkan.memory.buffer.IndirectBuffer indirectBuffer,
                        net.vulkanmod.render.chunk.util.StaticQueue<net.vulkanmod.render.chunk.RenderSection> queue,
                ...
                int count = 0;
                if (backFaceCulling) {
                        java.util.Iterator<net.vulkanmod.render.chunk.RenderSection> iterator = queue
                                        .iterator(isTranslucent);
                        ...
                        for (int j = 0; j < count; j++) {
                                ...
                                for (int i = 0; i < net.vulkanmod.render.chunk.cull.QuadFacing.COUNT; i++) {
                                        if ((mask & (1 << i)) == 0) {
                                                ...
                                                int indexCount_i = net.vulkanmod.render.chunk.buffer.DrawParametersBuffer
                                                                .getIndexCount(drawParamsPtr);
                                                int firstIndex_i = net.vulkanmod.render.chunk.buffer.DrawParametersBuffer
                                                                .getFirstIndex(drawParamsPtr);
                                                int vertexOffset_i = net.vulkanmod.render.chunk.buffer.DrawParametersBuffer
                                                                .getVertexOffset(drawParamsPtr);
                                                int baseInstance_i = net.vulkanmod.render.chunk.buffer.DrawParametersBuffer
                                                                .getBaseInstance(drawParamsPtr);
                                                if (indexCount == 0) {
                        ...
                        java.util.Iterator<net.vulkanmod.render.chunk.RenderSection> iterator2 = queue
                                        .iterator(isTranslucent);
                        ...
                        for (int i2 = 0; i2 < count; i2++) {
                                ...
                                int indexCount2 = net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.getIndexCount(
                                                drawParamsPtr2);
                                int firstIndex2 = net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.getFirstIndex(
                                                drawParamsPtr2);
                                int vertexOffset2 = net.vulkanmod.render.chunk.buffer.DrawParametersBuffer
                                                .getVertexOffset(
                                                                drawParamsPtr2);
                                int baseInstance2 = net.vulkanmod.render.chunk.buffer.DrawParametersBuffer
                                                .getBaseInstance(
                                                                drawParamsPtr2);
                                if (indexCount2 > 0) {
                ...
                java.nio.ByteBuffer byteBuffer = org.lwjgl.system.MemoryUtil.memByteBuffer(
                                cmdBufferPtr,
                                queue.size() * net.vulkanmod.render.chunk.cull.QuadFacing.COUNT * 32);
                indirectBuffer.recordCopyCmd(byteBuffer.position(0));
                org.lwjgl.vulkan.VK10.vkCmdDrawIndexedIndirect(
        ...
        public void buildDrawBatchesDirect(
                        net.minecraft.world.phys.Vec3 cameraPos,
                        net.vulkanmod.render.chunk.util.StaticQueue<net.vulkanmod.render.chunk.RenderSection> queue,
                        net.vulkanmod.render.vertex.TerrainRenderType terrainRenderType) {
                boolean isTranslucent = terrainRenderType == net.vulkanmod.render.vertex.TerrainRenderType.TRANSLUCENT;
                        ...
                        for (int j = 0; j < count; j++) {
                                ...
                                for (int i = 0; i < net.vulkanmod.render.chunk.cull.QuadFacing.COUNT; i++) {
                                        if ((mask & (1 << i)) == 0) {
                                                drawParamsBasePtr2 += 16;
                                                if (indexCount > 0) {
                                                        org.lwjgl.vulkan.VK10.vkCmdDrawIndexed(
                                                                        commandBuffer,
                                                                        indexCount,
                                                                        1,
                                                                        firstIndex,
                                ...
                                if (indexCount > 0) {
                                        org.lwjgl.vulkan.VK10.vkCmdDrawIndexed(
                                                        commandBuffer, indexCount, 1, firstIndex, vertexOffset,
                                                        baseInstance);
                                }
                        }
                        return;
                ...
                for (int i2 = 0; i2 < count; i2++) {
                        ...
                        int firstIndex2 = net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.getFirstIndex(
                                        drawParamsPtr2);
                        int vertexOffset2 = net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.getVertexOffset(
                                        drawParamsPtr2);
                        int baseInstance2 = net.vulkanmod.render.chunk.buffer.DrawParametersBuffer.getBaseInstance(
                                        drawParamsPtr2);
                        if (indexCount2 > 0) {
                                org.lwjgl.vulkan.VK10.vkCmdDrawIndexed(
                                                commandBuffer, indexCount2, 1, firstIndex2, vertexOffset2,
                                                baseInstance2);
                        }
                }
        }
        ...
        private int getMask(
                ...
                return mask
                                | (camera.x - ((double) secX) >= 0.0d
                                                ? 1 << net.vulkanmod.render.chunk.cull.QuadFacing.X_POS.ordinal()
                                                : 0)
                                | (camera.y - ((double) secY) >= 0.0d
                                                ? 1 << net.vulkanmod.render.chunk.cull.QuadFacing.Y_POS.ordinal()
                                                : 0)
                                | (camera.z - ((double) secZ) >= 0.0d
                                                ? 1 << net.vulkanmod.render.chunk.cull.QuadFacing.Z_POS.ordinal()
                                                : 0)
                                | (camera.x - ((double) (secX + 16)) < 0.0d
                                                ? 1 << net.vulkanmod.render.chunk.cull.QuadFacing.X_NEG.ordinal()
                                                : 0)
                                | (camera.y - ((double) (secY + 16)) < 0.0d
                                                ? 1 << net.vulkanmod.render.chunk.cull.QuadFacing.Y_NEG.ordinal()
                                                : 0)
                                | (camera.z - ((double) (secZ + 16)) < 0.0d
                                                ? 1 << net.vulkanmod.render.chunk.cull.QuadFacing.Z_NEG.ordinal()
                                                : 0);
        }
        ...
        public void bindBuffers(
                ...
                try {
                        ...
                        org.lwjgl.vulkan.VK10.nvkCmdBindVertexBuffers(
                                        commandBuffer, 0, 1, stack.npointer(vertexBuffer.getId()), stack.npointer(0L));
                        ...
                        if (ubo != null) {
                                ...
                                ubo.getBufferSlice()
                                                .set(
                                                                this.sectionDataBuffer,
                                                                0,
                                                                (int) this.sectionDataBuffer.getBufferSize());
                        }
                        if (terrainRenderType == net.vulkanmod.render.vertex.TerrainRenderType.TRANSLUCENT
                                        && this.indexBuffer != null) {
                                org.lwjgl.vulkan.VK10.vkCmdBindIndexBuffer(
                                                commandBuffer, this.indexBuffer.getId(), 0L, 0);
                        }
