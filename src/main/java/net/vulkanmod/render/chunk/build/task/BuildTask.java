...
public class BuildTask extends net.vulkanmod.render.chunk.build.task.ChunkTask {
    ...
    public BuildTask(
            ...
            net.vulkanmod.render.chunk.build.RenderRegion renderRegion,
    ...
    @Override // net.vulkanmod.render.chunk.build.task.ChunkTask
    public net.vulkanmod.render.chunk.build.task.ChunkTask.Result runTask(
    ...
    private net.vulkanmod.render.chunk.build.task.CompileResult compile(
            float camX,
            float camY,
            float camZ,
            net.vulkanmod.render.chunk.build.thread.BuilderResources builderResources) {
