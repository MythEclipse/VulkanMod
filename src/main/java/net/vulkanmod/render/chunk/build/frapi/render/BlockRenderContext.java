...
public class BlockRenderContext extends AbstractBlockRenderContext {
    public static final ThreadLocal<BlockRenderContext> POOL =
            ThreadLocal.withInitial(BlockRenderContext::new);
    ...
    public void render(
            ...
            BlockVertexConsumerProvider buffers,
            boolean cull,
            long seed,
            int overlay) {
    ...
    protected void endRenderQuad(MutableQuadViewImpl quad) {
        ...
        final boolean ao =
                this.useAO
                        && (aoMode == TriState.TRUE
                                || (aoMode == TriState.DEFAULT && this.defaultAO));
        ...
        final ChunkSectionLayer renderLayer =
                quadRenderLayer == null ? defaultRenderLayer : quadRenderLayer;
