...
public class ItemRenderContext
    ...
    private static final int GLINT_COUNT =
            net.minecraft.client.renderer.item.ItemStackRenderState.FoilType.values().length;
    ...
    private final com.mojang.blaze3d.vertex.VertexConsumer[] vertexConsumerCache =
            new com.mojang.blaze3d.vertex.VertexConsumer[3 * GLINT_COUNT];

    public void renderModel(
            net.minecraft.world.item.ItemDisplayContext itemDisplayContext,
            com.mojang.blaze3d.vertex.PoseStack matrixStack,
            net.minecraft.client.renderer.MultiBufferSource bufferSource,
            int lightmap,
            int overlay,
            int[] tints,
            java.util.List<net.minecraft.client.renderer.block.model.BakedQuad> modelQuads,
        ...
        java.util.Arrays.fill(
                this.vertexConsumerCache, (com.mojang.blaze3d.vertex.VertexConsumer) null);
    }

    private void bufferQuads(
            java.util.List<net.minecraft.client.renderer.block.model.BakedQuad> vanillaQuads,
            net.fabricmc.fabric.api.renderer.v1.mesh.MeshView mesh) {
    ...
    protected void bufferQuad(
        ...
        com.mojang.blaze3d.vertex.VertexConsumer vertexConsumer =
                getVertexConsumer(quad.renderLayer(), quad.glint());
        tintQuad(quad);
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            quad.lightmap(
                    ...
                    net.vulkanmod.render.chunk.build.frapi.helper.ColorHelper.maxBrightness(
                            quad.lightmap(i2), lightmap));
        }
    }

    private com.mojang.blaze3d.vertex.VertexConsumer getVertexConsumer(
            @org.jetbrains.annotations.Nullable
                    net.minecraft.client.renderer.chunk.ChunkSectionLayer quadRenderLayer,
            @org.jetbrains.annotations.Nullable
                    net.minecraft.client.renderer.item.ItemStackRenderState.FoilType quadGlint) {
        ...
        if (quadRenderLayer == null) {
            ...
            layer =
                    net.fabricmc.fabric.api.renderer.v1.render.RenderLayerHelper
                            .getEntityBlockLayer(quadRenderLayer);
        }
        ...
        com.mojang.blaze3d.vertex.VertexConsumer vertexConsumer =
                this.vertexConsumerCache[cacheIndex2];
    ...
    private com.mojang.blaze3d.vertex.VertexConsumer createVertexConsumer(
            net.minecraft.client.renderer.rendertype.RenderType layer,
            net.minecraft.client.renderer.item.ItemStackRenderState.FoilType glint) {
        if (glint != net.minecraft.client.renderer.item.ItemStackRenderState.FoilType.SPECIAL) {
            return net.minecraft.client.renderer.entity.ItemRenderer.getFoilBuffer(
                    this.vertexConsumerProvider,
                    layer,
                    true,
                    glint != net.minecraft.client.renderer.item.ItemStackRenderState.FoilType.NONE);
        }
        ...
        return net.vulkanmod.mixin.render.frapi.ItemRendererAccessor.getSpecialFoilBuffer(
                this.vertexConsumerProvider, layer, this.specialGlintEntry);
    }
}
