...
public class MeshViewImpl implements net.fabricmc.fabric.api.renderer.v1.mesh.MeshView {
    private static final java.lang.ThreadLocal<it.unimi.dsi.fastutil.objects.ObjectArrayList<net.vulkanmod.render.chunk.build.frapi.mesh.QuadViewImpl>> CURSOR_POOLS = java.lang.ThreadLocal
            .withInitial(
    ...
    @Override // net.fabricmc.fabric.api.renderer.v1.mesh.MeshView
    public void forEach(
            java.util.function.Consumer<? super net.fabricmc.fabric.api.renderer.v1.mesh.QuadView> action) {
        net.vulkanmod.render.chunk.build.frapi.mesh.QuadViewImpl cursor;
        it.unimi.dsi.fastutil.objects.ObjectArrayList<net.vulkanmod.render.chunk.build.frapi.mesh.QuadViewImpl> pool = CURSOR_POOLS
                .get();
        if (pool.isEmpty()) {
    ...
    <C extends net.vulkanmod.render.chunk.build.frapi.mesh.QuadViewImpl> void forEach(
        ...
        ((net.vulkanmod.render.chunk.build.frapi.mesh.QuadViewImpl) cursor).data = this.data;
