...
public abstract class MutableQuadViewImpl
    ...
    private static final net.fabricmc.fabric.api.renderer.v1.mesh.QuadTransform NO_TRANSFORM =
            q -> {
                return true;
            };
    private static final int[] DEFAULT_QUAD_DATA =
            new int[net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.TOTAL_STRIDE];
    ...
    private final it.unimi.dsi.fastutil.objects.ObjectArrayList<
            ...
            transformStack = new it.unimi.dsi.fastutil.objects.ObjectArrayList<>();
    private final net.fabricmc.fabric.api.renderer.v1.mesh.QuadTransform stackTransform =
            q -> {
                int i = this.transformStack.size() - 1;
                while (i >= 0) {
                    int i2 = i;
                    i--;
                    if (!((net.fabricmc.fabric.api.renderer.v1.mesh.QuadTransform)
                                    this.transformStack.get(i2))
                            .transform(q)) {
                        return false;
                    }
                }
    ...
    static {
        net.vulkanmod.render.chunk.build.frapi.mesh.MutableQuadViewImpl quad =
                new net.vulkanmod.render.chunk.build.frapi.mesh.MutableQuadViewImpl() {
                    @Override
    ...
    protected final void normalFlags(int flags) {
        this.data[this.baseIndex + 0] =
                net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.normalFlags(
    ...
    public final net.vulkanmod.render.chunk.build.frapi.mesh.MutableQuadViewImpl normal(
        ...
        this.data[
                        this.baseIndex
                                ...
                                + net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat
                                        .VERTEX_NORMAL] =
                net.vulkanmod.render.chunk.build.frapi.helper.NormalHelper.packNormal(x, y, z);
        return this;
    }
        ...
        for (int v = 0; v < 4; v++) {
            if ((normalFlags & (1 << v)) == 0) {
                this.data[
                                this.baseIndex
                                        + (v
                                                * net.vulkanmod.render.chunk.build.frapi.mesh
                                                        .EncodingFormat.VERTEX_STRIDE)
                                        + net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat
                                                .VERTEX_NORMAL] =
                        packedFaceNormal;
            }
    ...
    public final net.vulkanmod.render.chunk.build.frapi.mesh.MutableQuadViewImpl cullFace(
            net.minecraft.core.Direction face) {
        this.data[this.baseIndex + 0] =
                net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.cullFace(
    ...
    public net.vulkanmod.render.chunk.build.frapi.mesh.MutableQuadViewImpl renderLayer(
        ...
        this.data[this.baseIndex + 0] =
                net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.renderLayer(
    ...
    public net.vulkanmod.render.chunk.build.frapi.mesh.MutableQuadViewImpl emissive(
            boolean emissive) {
        this.data[this.baseIndex + 0] =
                net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.emissive(
    ...
    public net.vulkanmod.render.chunk.build.frapi.mesh.MutableQuadViewImpl diffuseShade(
            boolean shade) {
        this.data[this.baseIndex + 0] =
                net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.diffuseShade(
    ...
    public net.vulkanmod.render.chunk.build.frapi.mesh.MutableQuadViewImpl ambientOcclusion(
        ...
        this.data[this.baseIndex + 0] =
                net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.ambientOcclusion(
    ...
    public net.vulkanmod.render.chunk.build.frapi.mesh.MutableQuadViewImpl glint(
        ...
        this.data[this.baseIndex + 0] =
                net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.glint(
    ...
    public net.vulkanmod.render.chunk.build.frapi.mesh.MutableQuadViewImpl shadeMode(
        ...
        this.data[this.baseIndex + 0] =
                net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.shadeMode(
    ...
    public net.vulkanmod.render.chunk.build.frapi.mesh.MutableQuadViewImpl atlas(
        ...
        this.data[this.baseIndex + 0] =
                net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.quadAtlas(
    ...
    public final net.vulkanmod.render.chunk.build.frapi.mesh.MutableQuadViewImpl copyFrom(
        ...
        net.vulkanmod.render.chunk.build.frapi.mesh.QuadViewImpl q =
                (net.vulkanmod.render.chunk.build.frapi.mesh.QuadViewImpl) quad;
        java.lang.System.arraycopy(
                q.data,
                q.baseIndex,
                this.data,
    ...
    public final net.vulkanmod.render.chunk.build.frapi.mesh.MutableQuadViewImpl fromBakedQuad(
        ...
        int lightmap =
                net.minecraft.client.renderer.LightTexture.pack(lightEmission, lightEmission);
        lightmap(lightmap, lightmap, lightmap, lightmap);
        normalFlags(0);
        nominalFace(quad.direction());
        emissive(lightEmission == 15);
        diffuseShade(quad.shade());
        net.fabricmc.fabric.api.renderer.v1.mesh.QuadAtlas atlas =
                net.fabricmc.fabric.api.renderer.v1.mesh.QuadAtlas.of(
