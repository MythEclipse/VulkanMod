...
public class BlockRenderer
        extends net.vulkanmod.render.chunk.build.frapi.render.AbstractBlockRenderContext {
    ...
    public void renderBlock(
        ...
        model.emitQuads(
                getEmitter(), renderRegion, blockPos, blockState, this.random, this::isFaceCulled);
    }

    @Override // net.vulkanmod.render.chunk.build.frapi.render.AbstractBlockRenderContext
    protected com.mojang.blaze3d.vertex.VertexConsumer getVertexConsumer(
    ...
    protected void endRenderQuad(
        ...
        boolean ao =
                this.useAO
                        && (aoMode == net.fabricmc.fabric.api.util.TriState.TRUE
                                || (aoMode == net.fabricmc.fabric.api.util.TriState.DEFAULT
                                        && this.defaultAO));
        boolean emissive = quad.emissive();
        boolean vanillaShade =
                quad.shadeMode() == net.fabricmc.fabric.api.renderer.v1.mesh.ShadeMode.VANILLA;
        net.vulkanmod.render.vertex.TerrainBuilder terrainBuilder =
                getBufferBuilder(quad.renderLayer());
        net.vulkanmod.render.chunk.build.light.LightPipeline lightPipeline =
                ao ? this.smoothLightPipeline : this.flatLightPipeline;
        tintQuad(quad);
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: java.lang.MatchException */
    private net.vulkanmod.render.vertex.TerrainBuilder getBufferBuilder(
            net.minecraft.client.renderer.chunk.ChunkSectionLayer layer)
            throws java.lang.MatchException {
        if (layer == null) {
        ...
        net.vulkanmod.render.vertex.TerrainRenderType renderType =
                net.vulkanmod.render.vertex.TerrainRenderType.get(layer);
        net.vulkanmod.render.vertex.TerrainBuilder bufferBuilder =
                this.resources.builderPack.builder(
                        net.vulkanmod.render.vertex.TerrainRenderType.getRemapped(renderType));
    ...
    public void bufferQuad(
            net.vulkanmod.render.vertex.TerrainBuilder terrainBuilder,
            org.joml.Vector3f pos,
            net.vulkanmod.render.model.quad.ModelQuadView quad,
        ...
        if (this.renderType == net.vulkanmod.render.vertex.TerrainRenderType.TRANSLUCENT
        ...
        net.vulkanmod.render.vertex.TerrainBufferBuilder bufferBuilder =
                terrainBuilder.getBufferBuilder(quadFacing.ordinal());
        int packedNormal = quad.getNormal();
        float[] brightnessArr = quadLightData.br;
        int[] lights = quadLightData.lm;
        int idx =
                net.vulkanmod.render.model.quad.QuadUtils.getIterationStartIdx(
                        brightnessArr, lights);
