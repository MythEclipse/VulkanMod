...
public class FluidRenderer implements net.fabricmc.fabric.api.client.render.fluid.v1.FluidRendering.DefaultRenderer {
    ...
    public void render(net.fabricmc.fabric.api.client.render.fluid.v1.FluidRenderHandler handler, net.minecraft.world.level.block.state.BlockState blockState, net.minecraft.world.level.material.FluidState fluidState, net.minecraft.core.BlockPos blockPos, net.vulkanmod.render.vertex.TerrainBufferBuilder bufferBuilder) {
        ...
        net.minecraft.client.renderer.texture.TextureAtlasSprite[] sprites = handler.getFluidSprites(region, blockPos, fluidState);
        ...
        boolean useAO = blockState.getLightEmission() == 0 && net.minecraft.client.Minecraft.useAmbientOcclusion();
        net.vulkanmod.render.chunk.build.light.LightPipeline lightPipeline = useAO ? this.smoothLightPipeline : this.flatLightPipeline;

        net.minecraft.world.level.block.state.BlockState downState = getAdjBlockState(region, posX, posY, posZ, net.minecraft.core.Direction.DOWN);
        net.minecraft.world.level.block.state.BlockState upState = getAdjBlockState(region, posX, posY, posZ, net.minecraft.core.Direction.UP);
        net.minecraft.world.level.block.state.BlockState northState = getAdjBlockState(region, posX, posY, posZ, net.minecraft.core.Direction.NORTH);
        net.minecraft.world.level.block.state.BlockState southState = getAdjBlockState(region, posX, posY, posZ, net.minecraft.core.Direction.SOUTH);
        net.minecraft.world.level.block.state.BlockState westState = getAdjBlockState(region, posX, posY, posZ, net.minecraft.core.Direction.WEST);
        net.minecraft.world.level.block.state.BlockState eastState = getAdjBlockState(region, posX, posY, posZ, net.minecraft.core.Direction.EAST);

        boolean rUf = shouldRenderFace(region, blockPos, fluidState, blockState, net.minecraft.core.Direction.UP, upState);
        boolean rDf = shouldRenderFace(region, blockPos, fluidState, blockState, net.minecraft.core.Direction.DOWN, downState)
                && !isFaceOccludedByState(region, MAX_FLUID_HEIGHT, net.minecraft.core.Direction.DOWN, blockPos, downState);
        boolean rNf = shouldRenderFace(region, blockPos, fluidState, blockState, net.minecraft.core.Direction.NORTH, northState);
        boolean rSf = shouldRenderFace(region, blockPos, fluidState, blockState, net.minecraft.core.Direction.SOUTH, southState);
        boolean rWf = shouldRenderFace(region, blockPos, fluidState, blockState, net.minecraft.core.Direction.WEST, westState);
        boolean rEf = shouldRenderFace(region, blockPos, fluidState, blockState, net.minecraft.core.Direction.EAST, eastState);
        ...
        if (height >= 1.0F) {
            ...
            float s = this.getHeight(region, fluid, mBlockPos.set(blockPos).offset(net.minecraft.core.Direction.NORTH.getUnitVec3i()), northState);
            float t = this.getHeight(region, fluid, mBlockPos.set(blockPos).offset(net.minecraft.core.Direction.SOUTH.getUnitVec3i()), southState);
            float u = this.getHeight(region, fluid, mBlockPos.set(blockPos).offset(net.minecraft.core.Direction.EAST.getUnitVec3i()), eastState);
            float v = this.getHeight(region, fluid, mBlockPos.set(blockPos).offset(net.minecraft.core.Direction.WEST.getUnitVec3i()), westState);
            neHeight = this.calculateAverageHeight(region, fluid, height, s, u, mBlockPos.set(blockPos).offset(net.minecraft.core.Direction.NORTH.getUnitVec3i()).offset(net.minecraft.core.Direction.EAST.getUnitVec3i()));
            nwHeight = this.calculateAverageHeight(region, fluid, height, s, v, mBlockPos.set(blockPos).offset(net.minecraft.core.Direction.NORTH.getUnitVec3i()).offset(net.minecraft.core.Direction.WEST.getUnitVec3i()));
            seHeight = this.calculateAverageHeight(region, fluid, height, t, u, mBlockPos.set(blockPos).offset(net.minecraft.core.Direction.SOUTH.getUnitVec3i()).offset(net.minecraft.core.Direction.EAST.getUnitVec3i()));
            swHeight = this.calculateAverageHeight(region, fluid, height, t, v, mBlockPos.set(blockPos).offset(net.minecraft.core.Direction.SOUTH.getUnitVec3i()).offset(net.minecraft.core.Direction.WEST.getUnitVec3i()));
        }
        ...
        if (rUf && !isFaceOccludedByState(region, java.lang.Math.min(java.lang.Math.min(nwHeight, swHeight), java.lang.Math.min(seHeight, neHeight)), net.minecraft.core.Direction.UP, blockPos, upState)) {
            float u0, u1, u2, u3;
            float v0, v1, v2, v3;
        ...
        this.modelQuad.setFlags(net.vulkanmod.render.model.quad.ModelQuadFlags.IS_PARALLEL | net.vulkanmod.render.model.quad.ModelQuadFlags.IS_ALIGNED);
        ...
        for (net.minecraft.core.Direction direction : net.vulkanmod.render.chunk.util.Util.XZ_DIRECTIONS) {
            ...
            if (isFaceOccludedByState(region, java.lang.Math.max(h1, h2), direction, blockPos, adjState))
                continue;
            ...
            if (sprites.length > 2) {
                if (net.fabricmc.fabric.api.client.render.fluid.v1.FluidRenderHandlerRegistry.INSTANCE.isBlockTransparent(adjState.getBlock())) {
                    sprite = sprites[2];
                    isOverlay = true;
                }
            }
