...
public class FluidRenderer
    ...
    private final net.minecraft.core.BlockPos.MutableBlockPos mBlockPos =
            new net.minecraft.core.BlockPos.MutableBlockPos();
    private final net.vulkanmod.render.model.quad.ModelQuad modelQuad =
            new net.vulkanmod.render.model.quad.ModelQuad();
    ...
    public void renderLiquid(
        ...
        net.fabricmc.fabric.api.client.render.fluid.v1.FluidRenderHandler handler =
                net.fabricmc.fabric.api.client.render.fluid.v1.FluidRenderHandlerRegistry.INSTANCE
                        .get(fluidState.getType());
        net.vulkanmod.render.vertex.TerrainRenderType renderType =
                net.vulkanmod.render.vertex.TerrainRenderType.get(
    ...
    private boolean isFaceOccludedByState(
        ...
        if (blockState.canOcclude()) {
            net.minecraft.world.phys.shapes.VoxelShape occlusionShape =
            ...
            net.minecraft.world.phys.shapes.VoxelShape voxelShape =
                    net.minecraft.world.phys.shapes.Shapes.box(0.0d, 0.0d, 0.0d, 1.0d, h, 1.0d);
    ...
    public void render(
        ...
        net.minecraft.client.renderer.texture.TextureAtlasSprite[] sprites =
                handler.getFluidSprites(region, blockPos, fluidState);
        ...
        net.vulkanmod.render.chunk.build.light.LightPipeline lightPipeline =
                useAO ? this.smoothLightPipeline : this.flatLightPipeline;

        net.minecraft.world.level.block.state.BlockState downState =
                getAdjBlockState(region, posX, posY, posZ, net.minecraft.core.Direction.DOWN);
        net.minecraft.world.level.block.state.BlockState upState =
                getAdjBlockState(region, posX, posY, posZ, net.minecraft.core.Direction.UP);
        net.minecraft.world.level.block.state.BlockState northState =
                getAdjBlockState(region, posX, posY, posZ, net.minecraft.core.Direction.NORTH);
        net.minecraft.world.level.block.state.BlockState southState =
                getAdjBlockState(region, posX, posY, posZ, net.minecraft.core.Direction.SOUTH);
        net.minecraft.world.level.block.state.BlockState westState =
                getAdjBlockState(region, posX, posY, posZ, net.minecraft.core.Direction.WEST);
        net.minecraft.world.level.block.state.BlockState eastState =
                getAdjBlockState(region, posX, posY, posZ, net.minecraft.core.Direction.EAST);
        ...
        for (net.minecraft.core.Direction direction :
                net.vulkanmod.render.chunk.util.Util.XZ_DIRECTIONS) {
            float h1;
            float h2;
            float x1;
            float z1;
            ...
            if (isFaceOccludedByState(
                    region, java.lang.Math.max(h1, h2), direction, blockPos, adjState)) continue;

            net.minecraft.client.renderer.texture.TextureAtlasSprite sprite = sprites[1];
            boolean isOverlay = false;

            if (sprites.length > 2) {
                if (net.fabricmc.fabric.api.client.render.fluid.v1.FluidRenderHandlerRegistry
                        .INSTANCE
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$net$minecraft$core$Direction =
                new int[net.minecraft.core.Direction.values().length];
        ...
        static {
            ...
            try {
                $SwitchMap$net$minecraft$core$Direction[
                                net.minecraft.core.Direction.SOUTH.ordinal()] =
                        2;
            } catch (java.lang.NoSuchFieldError e2) {
            }
            try {
                $SwitchMap$net$minecraft$core$Direction[
                                net.minecraft.core.Direction.WEST.ordinal()] =
                        3;
            } catch (java.lang.NoSuchFieldError e3) {
            }
            try {
                $SwitchMap$net$minecraft$core$Direction[
                                net.minecraft.core.Direction.EAST.ordinal()] =
                        4;
    ...
    private float getHeight(
            ...
            net.minecraft.core.BlockPos blockPos) {
        net.minecraft.world.level.block.state.BlockState blockState =
                blockAndTintGetter.getBlockState(blockPos);
    ...
    private float getHeight(
        ...
        net.minecraft.world.level.block.state.BlockState blockState2 =
                blockAndTintGetter.getBlockState(
    ...
    private int calculateNormal(net.vulkanmod.render.model.quad.ModelQuad quad) {
        org.joml.Vector3f normal =
                new org.joml.Vector3f(quad.getX(1), quad.getY(1), quad.getZ(1))
                        .cross(quad.getX(3), quad.getY(3), quad.getZ(3));
        normal.normalize();
        return net.vulkanmod.render.vertex.format.I32_SNorm.packNormal(
    ...
    private void putQuad(
            ...
            float zOffset,
            boolean flip) {
        net.vulkanmod.render.chunk.build.light.data.QuadLightData quadLightData =
                this.resources.quadLightData;
