...
public class QuadViewImpl
    ...
    @org.jetbrains.annotations.Nullable protected net.minecraft.core.Direction nominalFace;
    protected int[] data;
    ...
    public final void load() {
        ...
        net.vulkanmod.render.chunk.build.frapi.helper.NormalHelper.unpackNormal(
                packedFaceNormal(), this.faceNormal);
    ...
    protected final void computeGeometry() {
        if (this.isGeometryInvalid) {
            this.isGeometryInvalid = false;
            net.vulkanmod.render.chunk.build.frapi.helper.NormalHelper.computeFaceNormal(
                    this.faceNormal, this);
            this.data[this.baseIndex + 1] =
                    net.vulkanmod.render.chunk.build.frapi.helper.NormalHelper.packNormal(
                            this.faceNormal);
            net.minecraft.core.Direction lightFace =
                    net.vulkanmod.render.chunk.build.frapi.helper.GeometryHelper.lightFace(this);
            this.data[this.baseIndex + 0] =
                    net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.lightFace(
                            this.data[this.baseIndex + 0], lightFace);
            this.data[this.baseIndex + 0] =
                    net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.geometryFlags(
                            this.data[this.baseIndex + 0],
                            net.vulkanmod.render.model.quad.ModelQuadFlags.getQuadFlags(
                                    this, lightFace));
            this.facing = net.vulkanmod.render.chunk.cull.QuadFacing.fromNormal(this.faceNormal);
        }
    }
    ...
    public final int geometryFlags() {
        computeGeometry();
        return net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.geometryFlags(
                this.data[this.baseIndex + 0]);
    }
    ...
    public final org.joml.Vector3f copyPos(
            int vertexIndex, @org.jetbrains.annotations.Nullable org.joml.Vector3f target) {
        if (target == null) {
        ...
        target.set(
                java.lang.Float.intBitsToFloat(this.data[index]),
                java.lang.Float.intBitsToFloat(this.data[index + 1]),
                java.lang.Float.intBitsToFloat(this.data[index + 2]));
        return target;
    }
        ...
        return this.data[
                this.baseIndex
                        + (vertexIndex
                                * net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat
                                        .VERTEX_STRIDE)
                        + net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.VERTEX_COLOR];
    }
    ...
    public final org.joml.Vector2f copyUv(
            int vertexIndex, @org.jetbrains.annotations.Nullable org.joml.Vector2f target) {
        if (target == null) {
    ...
    public final int normalFlags() {
        return net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.normalFlags(
                this.data[this.baseIndex + 0]);
    }
    ...
    protected final int normalIndex(int vertexIndex) {
        return this.baseIndex
                ...
                + net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.VERTEX_NORMAL;
    }

    @Override // net.fabricmc.fabric.api.renderer.v1.mesh.QuadView
    public final float normalX(int vertexIndex) {
        if (hasNormal(vertexIndex)) {
            return net.vulkanmod.render.chunk.build.frapi.helper.NormalHelper.unpackNormalX(
                    this.data[normalIndex(vertexIndex)]);
        }
        return Float.NaN;
    }
    ...
    public final float normalY(int vertexIndex) {
        if (hasNormal(vertexIndex)) {
            return net.vulkanmod.render.chunk.build.frapi.helper.NormalHelper.unpackNormalY(
                    this.data[normalIndex(vertexIndex)]);
        }
        return Float.NaN;
    }
    ...
    public final float normalZ(int vertexIndex) {
        if (hasNormal(vertexIndex)) {
            return net.vulkanmod.render.chunk.build.frapi.helper.NormalHelper.unpackNormalZ(
                    this.data[normalIndex(vertexIndex)]);
        }
        return Float.NaN;
    }
    ...
    public final net.minecraft.core.Direction lightFace() {
        computeGeometry();
        return net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.lightFace(
                this.data[this.baseIndex + 0]);
    }
    ...
    public boolean emissive() {
        return net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.emissive(
                this.data[this.baseIndex + 0]);
    }

    @Override // net.fabricmc.fabric.api.renderer.v1.mesh.QuadView
    public boolean diffuseShade() {
        return net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.diffuseShade(
                this.data[this.baseIndex + 0]);
    }

    @Override // net.fabricmc.fabric.api.renderer.v1.mesh.QuadView
    public net.fabricmc.fabric.api.util.TriState ambientOcclusion() {
        return net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.ambientOcclusion(
                this.data[this.baseIndex + 0]);
    }

    @Override // net.fabricmc.fabric.api.renderer.v1.mesh.QuadView
    public net.minecraft.client.renderer.item.ItemStackRenderState.FoilType glint() {
        return net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.glint(
                this.data[this.baseIndex + 0]);
    }

    @Override // net.fabricmc.fabric.api.renderer.v1.mesh.QuadView
    public net.fabricmc.fabric.api.renderer.v1.mesh.ShadeMode shadeMode() {
        return net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.shadeMode(
                this.data[this.baseIndex + 0]);
    }

    @Override // net.fabricmc.fabric.api.renderer.v1.mesh.QuadView
    public net.fabricmc.fabric.api.renderer.v1.mesh.QuadAtlas atlas() {
        return net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.quadAtlas(
                this.data[this.baseIndex + 0]);
    }
