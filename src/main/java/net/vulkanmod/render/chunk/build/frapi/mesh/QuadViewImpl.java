...
public class QuadViewImpl
        ...
        protected final void computeGeometry() {
                if (this.isGeometryInvalid) {
                        ...
                        this.data[this.baseIndex + 1] = net.vulkanmod.render.chunk.build.frapi.helper.NormalHelper
                                        .packNormal(
                                                        this.faceNormal);
                        net.minecraft.core.Direction lightFace = net.vulkanmod.render.chunk.build.frapi.helper.GeometryHelper
                                        .lightFace(this);
        ...
        public final float y(int vertexIndex) {
                return java.lang.Float.intBitsToFloat(
                                this.data[this.baseIndex
                                                + (vertexIndex
                                                                * net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.VERTEX_STRIDE)
                                                + net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.VERTEX_Y]);
        }
        ...
        public final float z(int vertexIndex) {
                return java.lang.Float.intBitsToFloat(
                                this.data[this.baseIndex
                                                + (vertexIndex
                                                                * net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.VERTEX_STRIDE)
                                                + net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.VERTEX_Z]);
        }
        ...
        public final float v(int vertexIndex) {
                return java.lang.Float.intBitsToFloat(
                                this.data[this.baseIndex
                                                + (vertexIndex
                                                                * net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.VERTEX_STRIDE)
                                                + net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.VERTEX_V]);
        }
        ...
        public final int lightmap(int vertexIndex) {
                return this.data[this.baseIndex
                                + (vertexIndex
                                                * net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.VERTEX_STRIDE)
                                + net.vulkanmod.render.chunk.build.frapi.mesh.EncodingFormat.VERTEX_LIGHTMAP];
        }
