...
public abstract class ShaderLoadUtil {
    public static final java.lang.String RESOURCES_PATH = net.vulkanmod.vulkan.shader.SPIRVUtils.class.getResource("/assets/vulkanmod").toExternalForm();
    public static final java.lang.String SHADERS_PATH = "%s/shaders/".formatted(RESOURCES_PATH);
    public static final java.util.Set<java.lang.String> REMAPPED_SHADERS = com.google.common.collect.Sets.newHashSet(new java.lang.String[]{"core/screenquad.vsh", "core/rendertype_item_entity_translucent_cull.vsh", "core/animate_sprite.vsh", "core/animate_sprite_blit.fsh"});

    public static java.lang.String resolveShaderPath(java.lang.String path) {
        return resolveShaderPath(SHADERS_PATH, path);
    }

    public static java.lang.String resolveShaderPath(java.lang.String shaderPath, java.lang.String path) {
        return "%s%s".formatted(shaderPath, path);
    }

    public static void loadShaders(net.vulkanmod.vulkan.shader.Pipeline.Builder pipelineBuilder, com.google.gson.JsonObject config, java.lang.String configName, java.lang.String path) {
        ...
        loadShader(pipelineBuilder, configName, path, vertexShader3, net.vulkanmod.vulkan.shader.SPIRVUtils.ShaderKind.VERTEX_SHADER);
        loadShader(pipelineBuilder, configName, path, fragmentShader3, net.vulkanmod.vulkan.shader.SPIRVUtils.ShaderKind.FRAGMENT_SHADER);
    }

    public static void loadShader(net.vulkanmod.vulkan.shader.Pipeline.Builder pipelineBuilder, java.lang.String configName, java.lang.String path, net.vulkanmod.vulkan.shader.SPIRVUtils.ShaderKind type) {
    ...
    public static void loadShader(net.vulkanmod.vulkan.shader.Pipeline.Builder pipelineBuilder, java.lang.String configName, java.lang.String path, java.lang.String shaderName, net.vulkanmod.vulkan.shader.SPIRVUtils.ShaderKind type) {
        java.lang.String source = getShaderSource(path, configName, shaderName, type);
        net.vulkanmod.vulkan.shader.SPIRVUtils.SPIRV spirv = net.vulkanmod.vulkan.shader.SPIRVUtils.compileShader(shaderName, source, type);
        switch (type) {
            case VERTEX_SHADER:
    ...
    public static java.lang.String getConfigFilePath(java.lang.String path, java.lang.String rendertype) {
        ...
        try {
            java.nio.file.Path filePath = java.nio.file.FileSystems.getDefault().getPath(configPath, new java.lang.String[0]);
            if (!java.nio.file.Files.exists(filePath, new java.nio.file.LinkOption[0])) {
                ...
                filePath = java.nio.file.FileSystems.getDefault().getPath(configPath2, new java.lang.String[0]);
            }
            if (!java.nio.file.Files.exists(filePath, new java.nio.file.LinkOption[0])) {
                return null;
            }
    ...
    public static com.google.gson.JsonObject getJsonConfig(java.lang.String path, java.lang.String rendertype) {
        ...
        try {
            ...
            com.google.gson.JsonObject reader = (com.google.gson.JsonObject) com.google.gson.JsonParser.parseReader(new java.io.BufferedReader(new java.io.InputStreamReader(stream)));
            stream.close();
            return reader;
        } catch (java.lang.Throwable e) {
            throw new java.lang.RuntimeException(e);
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            $SwitchMap$net$vulkanmod$vulkan$shader$SPIRVUtils$ShaderKind = new int[net.vulkanmod.vulkan.shader.SPIRVUtils.ShaderKind.values().length];
            try {
                $SwitchMap$net$vulkanmod$vulkan$shader$SPIRVUtils$ShaderKind[net.vulkanmod.vulkan.shader.SPIRVUtils.ShaderKind.VERTEX_SHADER.ordinal()] = 1;
            } catch (java.lang.NoSuchFieldError e3) {
            }
            try {
                $SwitchMap$net$vulkanmod$vulkan$shader$SPIRVUtils$ShaderKind[net.vulkanmod.vulkan.shader.SPIRVUtils.ShaderKind.FRAGMENT_SHADER.ordinal()] = 2;
            } catch (java.lang.NoSuchFieldError e4) {
            }
            try {
                $SwitchMap$net$vulkanmod$vulkan$shader$SPIRVUtils$ShaderKind[net.vulkanmod.vulkan.shader.SPIRVUtils.ShaderKind.COMPUTE_SHADER.ordinal()] = 3;
            } catch (java.lang.NoSuchFieldError e5) {
            }
        }
    }

    public static java.lang.String getShaderSource(net.minecraft.resources.Identifier resourceLocation, com.mojang.blaze3d.shaders.ShaderType type) {
        java.lang.String str;
        switch (net.vulkanmod.render.shader.ShaderLoadUtil.AnonymousClass1.$SwitchMap$com$mojang$blaze3d$shaders$ShaderType[type.ordinal()]) {
            case 1:
                str = ".vsh";
                break;
            case 2:
        ...
        try {
            ...
            java.lang.String source = org.apache.commons.io.IOUtils.toString(new java.io.BufferedReader(new java.io.InputStreamReader(stream)));
            stream.close();
            return source;
        } catch (java.lang.Throwable e) {
            throw new java.lang.RuntimeException(e);
    ...
    public static java.lang.String getShaderSource(java.lang.String path, com.mojang.blaze3d.shaders.ShaderType type) throws java.lang.MatchException {
        java.lang.String str;
        switch (net.vulkanmod.render.shader.ShaderLoadUtil.AnonymousClass1.$SwitchMap$com$mojang$blaze3d$shaders$ShaderType[type.ordinal()]) {
            case 1:
                str = ".vsh";
    ...
    public static java.lang.String getShaderSource(java.lang.String path, java.lang.String configName, java.lang.String shaderName, net.vulkanmod.vulkan.shader.SPIRVUtils.ShaderKind type) {
        java.lang.String str;
        switch (type) {
            case VERTEX_SHADER:
                str = ".vsh";
