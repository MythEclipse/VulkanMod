...
public abstract class PipelineManager {
    ...
    private static java.util.function.Function<
                    ...
                    net.vulkanmod.vulkan.shader.GraphicsPipeline>
            shaderGetter;
    ...
    public static void init() {
        ...
        net.vulkanmod.render.chunk.build.thread.ThreadBuilderPack
                .defaultTerrainBuilderConstructor();
    }
    ...
    private static void createBasicPipelines() {
        ...
        fastBlitPipeline =
                createPipeline("blit", net.vulkanmod.render.vertex.CustomVertexFormat.NONE);
        cloudsPipeline =
                createPipeline(
                        "clouds", com.mojang.blaze3d.vertex.DefaultVertexFormat.POSITION_COLOR);
    }

    private static net.vulkanmod.vulkan.shader.GraphicsPipeline createPipeline(
            java.lang.String configName, com.mojang.blaze3d.vertex.VertexFormat vertexFormat) {
        net.vulkanmod.vulkan.shader.Pipeline.Builder pipelineBuilder =
                new net.vulkanmod.vulkan.shader.Pipeline.Builder(vertexFormat, configName);
        java.lang.String path =
                net.vulkanmod.render.shader.ShaderLoadUtil.resolveShaderPath("basic");
        com.google.gson.JsonObject config =
                net.vulkanmod.render.shader.ShaderLoadUtil.getJsonConfig(path, configName);
        pipelineBuilder.parseBindings(config);
        net.vulkanmod.render.shader.ShaderLoadUtil.loadShaders(
                pipelineBuilder, config, configName, path);
        net.vulkanmod.vulkan.shader.GraphicsPipeline pipeline =
                pipelineBuilder.createGraphicsPipeline();
    ...
    public static net.vulkanmod.vulkan.shader.GraphicsPipeline getTerrainShader(
    ...
    public static net.vulkanmod.vulkan.shader.GraphicsPipeline getTerrainDirectShader(
            net.minecraft.client.renderer.rendertype.RenderType renderType) {
        return terrainShader;
    }

    public static net.vulkanmod.vulkan.shader.GraphicsPipeline getTerrainIndirectShader(
            net.minecraft.client.renderer.rendertype.RenderType renderType) {
