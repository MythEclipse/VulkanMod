    ...
    public static void takeScreenshot(
        ...
        if (gpuTexture == null) {
            throw new IllegalStateException(
                    "Tried to capture screenshot of an incomplete framebuffer");
        } else {
            ...
            RenderSystem.getDevice()
                    ...
                    .copyTextureToBuffer(
                            ...
                            0,
                            () -> {
                                try (GpuBuffer.MappedView readView =
                                        commandEncoder.mapBuffer(gpuBuffer, true, false)) {
                                    ...
                                    var colorAttachment =
                                            ((VkGpuTexture)
                                                    Renderer.getInstance()
                                                            .getMainPass()
                                                            .getColorAttachment());
                                    boolean isBgraFormat =
                                            (colorAttachment.getVulkanImage().format
