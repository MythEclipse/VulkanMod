...
public class Drawer {
    ...
    private final net.vulkanmod.vulkan.memory.buffer.index.AutoIndexBuffer quadsIndexBuffer =
            new net.vulkanmod.vulkan.memory.buffer.index.AutoIndexBuffer(
                    65536, net.vulkanmod.vulkan.memory.buffer.index.AutoIndexBuffer.DrawType.QUADS);
    private final net.vulkanmod.vulkan.memory.buffer.index.AutoIndexBuffer quadsIntIndexBuffer =
            new net.vulkanmod.vulkan.memory.buffer.index.AutoIndexBuffer(
                    100000,
                    net.vulkanmod.vulkan.memory.buffer.index.AutoIndexBuffer.DrawType.QUADS);
    private final net.vulkanmod.vulkan.memory.buffer.index.AutoIndexBuffer linesIndexBuffer =
            new net.vulkanmod.vulkan.memory.buffer.index.AutoIndexBuffer(
                    10000, net.vulkanmod.vulkan.memory.buffer.index.AutoIndexBuffer.DrawType.LINES);
    private final net.vulkanmod.vulkan.memory.buffer.index.AutoIndexBuffer
            debugLineStripIndexBuffer =
                    new net.vulkanmod.vulkan.memory.buffer.index.AutoIndexBuffer(
                            10000,
                            net.vulkanmod.vulkan.memory.buffer.index.AutoIndexBuffer.DrawType
                                    .DEBUG_LINE_STRIP);
    private final net.vulkanmod.vulkan.memory.buffer.index.AutoIndexBuffer triangleFanIndexBuffer =
            new net.vulkanmod.vulkan.memory.buffer.index.AutoIndexBuffer(
                    1000,
                    net.vulkanmod.vulkan.memory.buffer.index.AutoIndexBuffer.DrawType.TRIANGLE_FAN);
    private final net.vulkanmod.vulkan.memory.buffer.index.AutoIndexBuffer
            triangleStripIndexBuffer =
                    new net.vulkanmod.vulkan.memory.buffer.index.AutoIndexBuffer(
                            10000,
                            net.vulkanmod.vulkan.memory.buffer.index.AutoIndexBuffer.DrawType
                                    .TRIANGLE_STRIP);
    ...
    public void draw(
            ...
            int vertexCount)
            throws java.lang.MatchException {
        net.vulkanmod.vulkan.memory.buffer.VertexBuffer vertexBuffer =
                this.vertexBuffers[this.currentFrame];
        ...
        if (indexData != null) {
            net.vulkanmod.vulkan.memory.buffer.IndexBuffer indexBuffer =
                    this.indexBuffers[this.currentFrame];
        ...
        net.vulkanmod.vulkan.memory.buffer.index.AutoIndexBuffer autoIndexBuffer =
                getAutoIndexBuffer(mode, vertexCount);
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                $SwitchMap$com$mojang$blaze3d$vertex$VertexFormat$Mode[
                                com.mojang.blaze3d.vertex.VertexFormat.Mode.POINTS.ordinal()] =
                        6;
    ...
    public net.vulkanmod.vulkan.memory.buffer.index.AutoIndexBuffer getAutoIndexBuffer(
            ...
            throws java.lang.MatchException {
        switch (net.vulkanmod.vulkan.Drawer.AnonymousClass1
                .$SwitchMap$com$mojang$blaze3d$vertex$VertexFormat$Mode[mode.ordinal()]) {
            case 1:
