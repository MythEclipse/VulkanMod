...
public class Framebuffer {
    ...
    public void beginRenderPass(
            VkCommandBuffer commandBuffer, RenderPass renderPass, MemoryStack stack) {
    ...
    protected long getFramebufferId(RenderPass renderPass) {
        return this.renderpassToFramebufferMap.computeIfAbsent(
                renderPass, renderPass1 -> createFramebuffer(renderPass));
    }
    ...
    public int getColorAttachmentMipLevel() {
        return colorAttachmentMipLevel;
    }
    ...
    public static Builder builder(
            int width, int height, int colorAttachments, boolean hasDepthAttachment) {
    ...
    public static Builder builder(
            VulkanImage colorAttachment, VulkanImage depthAttachment, int mipLevel) {
