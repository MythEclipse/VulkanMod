...
public abstract class ImageUtil {
    ...
    public static void downloadTexture(VulkanImage image, long ptr) {
        try (MemoryStack stack = stackPush()) {
            ...
            CommandPool.CommandBuffer commandBuffer =
                    DeviceManager.getGraphicsQueue().beginCommands();
            image.transitionImageLayout(
                    stack, commandBuffer.getHandle(), VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL);
            ...
            MemoryManager.MapAndCopy(
                    pStagingAllocation.get(0),
    ...
    public static void copyImageToBufferCmd(
        ...
        vkCmdCopyImageToBuffer(
                commandBuffer, image, VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL, buffer, region);
    }
    ...
    public static void blitFramebuffer(
        ...
        try (MemoryStack stack = stackPush()) {
            ...
            dstImage.transitionImageLayout(
                    stack, commandBuffer, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL);
            ...
            srcImage.transitionImageLayout(
                    stack, commandBuffer, VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL);
    ...
    public static void generateMipmaps(VulkanImage image) {
        try (MemoryStack stack = stackPush()) {
            ...
            image.transitionImageLayout(
                    stack, commandBuffer.getHandle(), VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL);
