...
@org.spongepowered.asm.mixin.Mixin({net.minecraft.client.renderer.texture.SpriteContents.AnimationState.class})
public class MSpriteContents {
    ...
    private net.minecraft.client.renderer.texture.SpriteContents.AnimatedTexture animationInfo;
