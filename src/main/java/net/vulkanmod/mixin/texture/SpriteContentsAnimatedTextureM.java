...
@org.spongepowered.asm.mixin.Mixin({net.minecraft.client.renderer.texture.SpriteContents.AnimatedTexture.class})
public class SpriteContentsAnimatedTextureM {
    @org.spongepowered.asm.mixin.injection.ModifyArg(method = {"createAnimationState"}, at = @org.spongepowered.asm.mixin.injection.At(value = "INVOKE", target = "Lcom/mojang/blaze3d/systems/GpuDevice;createTexture(Ljava/util/function/Supplier;ILcom/mojang/blaze3d/textures/TextureFormat;IIII)Lcom/mojang/blaze3d/textures/GpuTexture;"), index = 6)
