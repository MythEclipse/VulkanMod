...
public class RenderTypeM implements net.vulkanmod.interfaces.ExtendedRenderType {
    ...
    private void inj(
            ...
            net.minecraft.client.renderer.rendertype.RenderSetup renderSetup,
    ...
    public void draw(com.mojang.blaze3d.vertex.MeshData meshData) {
        ...
        net.vulkanmod.mixin.render.RenderSetupAccessor renderSetupAccessor =
                (net.vulkanmod.mixin.render.RenderSetupAccessor) (Object) this.state;
        java.util.function.Consumer<org.joml.Matrix4fStack> consumer =
                renderSetupAccessor.layeringTransform().getModifier();
        if (consumer != null) {
            matrix4fStack.pushMatrix();
            consumer.accept(matrix4fStack);
        }
        com.mojang.blaze3d.buffers.GpuBufferSlice gpuBufferSlice =
                com.mojang.blaze3d.systems.RenderSystem.getDynamicUniforms()
                        .writeTransform(
        ...
        if (meshData.indexBuffer() == null) {
            com.mojang.blaze3d.systems.RenderSystem.AutoStorageIndexBuffer autoStorageIndexBuffer =
                    com.mojang.blaze3d.systems.RenderSystem.getSequentialBuffer(
        ...
        com.mojang.blaze3d.pipeline.RenderTarget renderTarget =
                renderSetupAccessor.outputTarget().getRenderTarget();
        ...
        com.mojang.blaze3d.textures.GpuTextureView gpuTextureView2 =
        ...
        try {
            ...
            com.mojang.blaze3d.systems.ScissorState scissorState =
                    com.mojang.blaze3d.systems.RenderSystem.getScissorStateForRenderTypeDraws();
            ...
            for (java.util.Map.Entry<
                ...
                renderPass.bindTexture(
                        entry.getKey(), entry.getValue().textureView(), entry.getValue().sampler());
            }
            renderPass.setIndexBuffer(gpuBuffer2, indexType);
            net.vulkanmod.render.engine.VkCommandEncoder commandEncoder =
                    (net.vulkanmod.render.engine.VkCommandEncoder)
                            com.mojang.blaze3d.systems.RenderSystem.getDevice()
                                    .createCommandEncoder();
