...
public interface VertexConsumerM {
    ...
    default void putBulkData(
        ...
        boolean trustedNormals =
                ((net.vulkanmod.mixin.matrix.PoseAccessor) (Object) pose).trustedNormals();
        int packedNormal =
                net.vulkanmod.render.util.MathUtil.packTransformedNorm(
                        pose.normal(), trustedNormals, vector3fc.x(), vector3fc.y(), vector3fc.z());
        ...
        for (int l = 0; l < 4; l++) {
            ...
            addVertex(
                    ...
                    overlay,
                    light,
                    net.vulkanmod.render.vertex.format.I32_SNorm.unpackX(packedNormal),
                    net.vulkanmod.render.vertex.format.I32_SNorm.unpackY(packedNormal),
                    net.vulkanmod.render.vertex.format.I32_SNorm.unpackZ(packedNormal));
        }
    }
}
