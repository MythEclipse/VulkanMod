...
@org.spongepowered.asm.mixin.Mixin({
    net.minecraft.client.renderer.item.ItemStackRenderState.LayerRenderState.class
})
abstract class ItemStackRenderStateLayerRenderStateM
        implements net.fabricmc.fabric.api.renderer.v1.render.FabricLayerRenderState,
                net.vulkanmod.render.chunk.build.frapi.accessor.AccessLayerRenderState {

    @org.spongepowered.asm.mixin.Unique
    private final net.vulkanmod.render.chunk.build.frapi.mesh.MutableMeshImpl mutableMesh =
            new net.vulkanmod.render.chunk.build.frapi.mesh.MutableMeshImpl();
    ...
    @org.spongepowered.asm.mixin.injection.Redirect(
            ...
            at =
                    @org.spongepowered.asm.mixin.injection.At(
                            value = "INVOKE",
                            target =
                                    "Lnet/minecraft/client/renderer/SubmitNodeCollector;submitItem(Lcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/world/item/ItemDisplayContext;III[ILjava/util/List;Lnet/minecraft/client/renderer/rendertype/RenderType;Lnet/minecraft/client/renderer/item/ItemStackRenderState$FoilType;)V"))
    private void submitItemProxy(
        ...
        if (this.mutableMesh.size() > 0
            ...
            net.vulkanmod.render.chunk.build.frapi.accessor.AccessRenderCommandQueue access =
                    (net.vulkanmod.render.chunk.build.frapi.accessor.AccessRenderCommandQueue)
                            commandQueue;
            access.submitItem(
                    matrices,
                    ...
                    glint,
                    this.mutableMesh,
                    this.renderTypeGetter);
        } else {
            commandQueue.submitItem(
                    matrices,
                    displayContext,
                    light,
                    overlay,
    ...
    @Override // net.fabricmc.fabric.api.renderer.v1.render.FabricLayerRenderState,
    // net.vulkanmod.render.chunk.build.frapi.accessor.AccessLayerRenderState
    public void setRenderTypeGetter(
