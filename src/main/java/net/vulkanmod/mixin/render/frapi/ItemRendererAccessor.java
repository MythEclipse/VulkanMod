...
public interface ItemRendererAccessor {
    ...
    static com.mojang.blaze3d.vertex.VertexConsumer getSpecialFoilBuffer(net.minecraft.client.renderer.MultiBufferSource provider, net.minecraft.client.renderer.rendertype.RenderType layer, com.mojang.blaze3d.vertex.PoseStack.Pose entry) {
