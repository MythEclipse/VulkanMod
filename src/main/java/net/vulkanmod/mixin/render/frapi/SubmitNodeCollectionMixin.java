...
abstract class SubmitNodeCollectionMixin
        implements net.minecraft.client.renderer.OrderedSubmitNodeCollector,
                net.vulkanmod.render.chunk.build.frapi.accessor.AccessRenderCommandQueue,
                net.vulkanmod.render.chunk.build.frapi.accessor.AccessBatchingRenderCommandQueue {

    @org.spongepowered.asm.mixin.Shadow private boolean wasUsed;

    @org.spongepowered.asm.mixin.Unique
    private final java.util.List<net.vulkanmod.render.chunk.build.frapi.render.MeshItemCommand>
            meshItemCommands = new java.util.ArrayList();
    ...
    public void submitItem(
        ...
        this.wasUsed = true;
        this.meshItemCommands.add(
                new net.vulkanmod.render.chunk.build.frapi.render.MeshItemCommand(
                        matrices.last().copy(),
                        displayContext,
                        light,
                        overlay,
    ...
    public java.util.List<net.vulkanmod.render.chunk.build.frapi.render.MeshItemCommand>
            getMeshItemCommands() {
