...
public class QuadParticleRenderStateM {
    ...
    public void renderRotatedQuad(
        ...
        this.renderVertex(
                vertexBuilder, quaternionf, x, y, z, 1.0F, -1.0F, m, u1, v1, color, light);
        this.renderVertex(vertexBuilder, quaternionf, x, y, z, 1.0F, 1.0F, m, u1, v0, color, light);
        this.renderVertex(
                vertexBuilder, quaternionf, x, y, z, -1.0F, 1.0F, m, u0, v0, color, light);
        this.renderVertex(
                vertexBuilder, quaternionf, x, y, z, -1.0F, -1.0F, m, u0, v1, color, light);
    }
    ...
    private void renderVertex(
            ...
            int color,
            int light) {
        vector3f.set(i, j, 0.0f).rotate(quaternionf).mul(k).add(x, y, z);
