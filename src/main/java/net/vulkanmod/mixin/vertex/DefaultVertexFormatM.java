    ...
    @org.spongepowered.asm.mixin.injection.Redirect(
            ...
            at =
                    @org.spongepowered.asm.mixin.injection.At(
                            value = "INVOKE",
                            target =
                                    "Lcom/mojang/blaze3d/vertex/VertexFormat$Builder;build()Lcom/mojang/blaze3d/vertex/VertexFormat;",
                            ordinal = 14))
    private static com.mojang.blaze3d.vertex.VertexFormat fixMissingPaddingFormat(
            com.mojang.blaze3d.vertex.VertexFormat.Builder instance) {
        return com.mojang.blaze3d.vertex.VertexFormat.builder()
                ...
                .padding(1)
                .add("LineWidth", com.mojang.blaze3d.vertex.VertexFormatElement.LINE_WIDTH)
                .build();
    }
}
